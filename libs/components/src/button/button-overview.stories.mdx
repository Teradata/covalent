...
<Canvas>
  <cv-button label="Text button"></cv-button>
  <cv-button label="Outlined button" outlined></cv-button>
  <cv-button label="Contained button" raised></cv-button>
</Canvas>
...
<Canvas>
  ...
  <cv-button id="left-icon" raised label="Left icon" icon="sailing"></cv-button>
  <cv-button
    id="right-icon"
    raised
    label="Right icon"
...
<Canvas>
  <form>
    <cv-button outlined label="Button"></cv-button>
    <cv-button outlined label="Button"></cv-button>
    <cv-button raised label="Delete" color="negative"></cv-button>
  </form>
</Canvas>
...
<Canvas>
  <cv-button outlined label="Delete" class="destructive"></cv-button>
  <cv-button outlined label="Button"></cv-button>
  <cv-button raised label="Primary"></cv-button>
</Canvas>
