...
<div class="container">
  <div class="toolbar">
    ...
    <div class="actions">
      <cv-button outlined slot="buttonActions">
        Action
      </cv-button>
      <cv-button outlined slot="buttonActions">
        Action
  ...
  <cv-tab-bar activeIndex="0">
    <cv-tab null label="Details"></cv-tab>
    <cv-tab null label="Tab 2"></cv-tab>
    <cv-tab null label="Tab 3"></cv-tab>
    <cv-tab null label="Tab 4"></cv-tab>
  </cv-tab-bar>
  <hr />
  <div class="content">
    <div>
      ...
      <cv-chip-set>
        <cv-chip label="Lorem"></cv-chip>
        <cv-chip label="Ipsum"></cv-chip>
        <cv-chip label="Dolor sit"></cv-chip>
      </cv-chip-set>
    </div>
    <cv-icon-button icon="edit"></cv-icon-button>
  </div>
</div>
  ...
  <div class="changes-container-item">
    ...
    <div class="changes-example">
      ...
      <cv-action-ribbon labelText="No changes" state="undefined" null>
        ...
        <cv-button slot="action-items" raised disabled>
          Save
        </cv-button>
      </cv-action-ribbon>
  ...
  <div class="changes-container-item">
    ...
    <div class="changes-example">
      ...
      >
        ...
        <cv-button slot="action-items" raised>
          Save
        </cv-button>
      </cv-action-ribbon>
      <div class="action-ribbon-bottom-content">
