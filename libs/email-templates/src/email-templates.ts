...
import welcomeLetter from './mjml-templates/customer/welcomeLetter.mjml';
import workshop from './mjml-templates/marketing/workshop.mjml';
import cssStyles from './styles/_generated.css';
import mjmlStyles from './styles/mjmlStyles.mjml';
