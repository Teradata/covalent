...
- **icons:** added and updated covalent icons ([e36b88e](https://github.com/Teradata/covalent/commit/e36b88e4c3446502c25d6393c26c1760f3288801))

## [11.20.1](https://github.com/Teradata/covalent/compare/v11.20.0...v11.20.1) (2026-07-28)

### Bug Fixes

- **md-navigator:** fix multilanguage support on md-navigator breadcrumbs ([35bd4c4](https://github.com/Teradata/covalent/commit/35bd4c4176adc24ad5538e78561f74afe8bed2bf))
...
- **markdown-navigator:** add conf to render covalent and material icons ([#2615](https://github.com/Teradata/covalent/issues/2615)) ([6138582](https://github.com/Teradata/covalent/commit/613858253f954005614bfea0e3144274835b9ebc))

## [11.6.1](https://github.com/Teradata/covalent/compare/v11.6.0...v11.6.1) (2025-12-15)

### Bug Fixes

- **cv-radio:** update styling on radio states ([#2611](https://github.com/Teradata/covalent/issues/2611)) ([f260327](https://github.com/Teradata/covalent/commit/f2603277623f9dce4c40387ad1eb44b9cd6b763f))
...
- **flavored-markdown:** update table styles CAT-2556 ([#2601](https://github.com/Teradata/covalent/issues/2601)) ([4cb91f3](https://github.com/Teradata/covalent/commit/4cb91f39e7f163621ef018e220caa1081df284aa))
...
- update components package.json dependencies ([#2581](https://github.com/Teradata/covalent/issues/2581)) ([642011c](https://github.com/Teradata/covalent/commit/642011c9e65b2c111b955a4faab728429ce7bb73))
...
- **icons:** rename ask_ai icon to ai_assistant ([#2578](https://github.com/Teradata/covalent/issues/2578)) ([b126dd4](https://github.com/Teradata/covalent/commit/b126dd472ebc18698ce099debff5637a4ab29cf6))
...
- **divider:** enhance divider styles and update stories layout ([#2538](https://github.com/Teradata/covalent/issues/2538)) ([0db0b1d](https://github.com/Teradata/covalent/commit/0db0b1d4cffc10015442787ff05466e54e9b721d))
...
- **package:** @types/react to version 19.1.3 ([ad32c59](https://github.com/Teradata/covalent/commit/ad32c59668afba5e678bf1f62863addf478e139e))

### Features

- **components:** updating storybook and component styles ([35034ea](https://github.com/Teradata/covalent/commit/35034ea6c60173b89cb141f6d6cdb875066a7e2e))
...
- **angular:** update import statements in public_api.ts ([88e68f2](https://github.com/Teradata/covalent/commit/88e68f2e48fe1653157ca55226a292183fdb34a9))
...
# [10.1.0-beta.1](https://github.com/Teradata/covalent/compare/v10.0.4...v10.1.0-beta.1) (2025-03-25)
...
# [10.1.0-beta.1](https://github.com/Teradata/covalent/compare/v10.0.4...v10.1.0-beta.1) (2025-03-24)
...
- **components:** adjusting the height layout of alert on resize ([6f94c42](https://github.com/Teradata/covalent/commit/6f94c42da472f0be56f8aee1906f5147d2161c4e))
- **components:** adjusting the height layout of alert on resize ([2702d27](https://github.com/Teradata/covalent/commit/2702d27627812fa7ad19ff38b75802abc4d7b0f3))
...
```html
<td-expansion-panel-group></td-expansion-panel-group>
```

After:

```html
<td-expansion-panel-group multi></td-expansion-panel-group>
```
...
```html
<td-layout>
  <div td-sidenav-content>Main Sidenav content</div>
  <td-layout-nav toolbarTitle="Title">
...
<td-layout-nav toolbarTitle="Title">
  ...
  <td-layout-manage-list #manageList>
    <div td-sidenav-content>Manage List Sidenav Content</div>
    Content
  </td-layout-manage-list>
</td-layout-nav>
```
...
- **layouts:** `logo` expects an `svgIcon` value now from an `MdIconRegistry` svg. (breaking change from `@angular/material`). ([6cd31f063ae5a1fd0e31378c1bbf6c466a7d3c15](https://github.com/Teradata/covalent/commit/6cd31f063ae5a1fd0e31378c1bbf6c466a7d3c15))
  ...
  ```html
  <td-layout logo="/assets/route/to/icon1.svg"></td-layout>
  ```
  ...
  ```html
  <td-layout logo="assets:icon1"></td-layout>
  ```
...
- **layouts:** Changed placeholders to accept attributes since angular2 complains if the element doesnt exist, and turned md-content into a class since `angular2-material` never intended for it to be a component. ([ab67c403d0aad3022e2e0112dfd62a89295c4f4b](https://github.com/Teradata/covalent/commit/ab67c403d0aad3022e2e0112dfd62a89295c4f4b))
  ...
  <list-toolbar-content> ... </list-toolbar-content>

  <toolbar-buttons> ... </toolbar-buttons>

  <nav-toolbar-content> ... </nav-toolbar-content>
