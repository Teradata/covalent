import"./dialog-42d5e022.js";import"./query-assigned-elements-9f88bee1.js";import"./tslib.es6-4b90b051.js";import"./inert.esm-a76031cb.js";import"./base-element-cae00a28.js";import"./utils-529e1a6d.js";import"./observer-1f401936.js";import"./property-f36ea729.js";import"./query-3e91a3b8.js";import"./class-map-018c3a6a.js";const h=`<cv-button data-num="1" raised>Basic</cv-button>
...
`,A=({})=>(document.addEventListener("DOMContentLoaded",()=>{const o=document.body.querySelectorAll("cv-button[data-num]");for(let t=0;t<o.length;t++){const e=o[t],n=e.dataset.num,m=(b=>function(){const p=document.body.querySelector("#dialog"+b);p.open=!0})(n);e.addEventListener("click",m)}window.toggleActions.onclick=function(){const t=document.body.querySelector("#dialog4"),e=document.body.querySelector("#hideActionVal"),n=!t.hideActions;t.hideActions=n,e.innerText=n};const l=document.querySelector("#dialog8"),r=document.querySelector("#dialog8-text-field");document.querySelector("#dialog8-primary-action-button").addEventListener("click",()=>{if(r.checkValidity()){l.close();return}r.reportValidity()})},{once:!0}),h),B={title:"Components/Dialog"},f=()=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#dialog-button").addEventListener("click",()=>{const l=document.body.querySelector("#dialog1");l.open=!0})},{once:!0}),`
    ...
    </cv-dialog>`),_=A.bind({}),i=f.bind({}),k=({})=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#logout-button").addEventListener("click",()=>{const l=document.body.querySelector("#example-logout");l.open=!0})},{once:!0}),`
...
}`,...(x=(u=c.parameters)==null?void 0:u.docs)==null?void 0:x.source}}};var w,v,R;a.parameters={...a.parameters,docs:{...(w=a.parameters)==null?void 0:w.docs,source:{originalSource:`({}) => {
  document.addEventListener('DOMContentLoaded', () => {
...
}`,...(R=(v=a.parameters)==null?void 0:v.docs)==null?void 0:R.source}}};const H=["Basic","Anatomy","Logout","UDF"];export{i as Anatomy,_ as Basic,c as Logout,a as UDF,H as __namedExportsOrder,B as default};
//# sourceMappingURL=dialog.stories-80204fdb.js.map
