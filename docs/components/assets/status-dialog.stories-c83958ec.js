...
`,bt={title:"Components/Status Dialog",argTypes:{state:{options:["error","positive","warning"],control:{type:"select"}}},args:{state:"error",open:!1,hideActions:!1,heading:"Basic heading for the dialog"}},h=({state:t,hideActions:e,heading:o})=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#dialog-button").addEventListener("click",()=>{const c=document.body.querySelector("#dialog");c.open=!0})},{once:!0}),`
