import{s as z,x as $,i as E,r as F,e as R}from"./query-assigned-elements-DrVEbY-Z.js";import{n as s}from"./property-jaip2ZBL.js";import{t as A}from"./state-BvMmCZpn.js";import{o as f}from"./class-map-BiVinSLa.js";import"./typography-DUYqxpre.js";import"./icon-t35jb-S6.js";import"./circular-progress-vxrruSTq.js";import"./directive-CvdRHFdJ.js";import"./mwc-icon-BqP9gbHN.js";import"./tslib.es6-BHOXe2z4.js";import"./aria-property-BYXgNswj.js";import"./if-defined-BYt77_e6.js";import"./style-map-CYkhWXm1.js";const G='.filled{font-variation-settings:"FILL" 1}.hidden{display:none}.icon-lockup{align-items:center;display:flex;gap:4px;max-width:100%}.icon-lockup cv-typography{flex:1 0 0}.icon-lockup--primary,.icon-lockup--loading{color:var(--cv-theme-primary)}.icon-lockup--positive{color:var(--cv-theme-positive)}.icon-lockup--negative{color:var(--cv-theme-negative)}.icon-lockup--caution{color:var(--cv-theme-caution)}.text{font-feature-settings:"liga" off,"clig" off;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.trailing-icon{flex-direction:row-reverse}';var H=Object.defineProperty,J=Object.getOwnPropertyDescriptor,i=(o,e,c,a)=>{for(var n=a>1?void 0:a?J(e,c):e,r=o.length-1,g;r>=0;r--)(g=o[r])&&(n=(a?g(e,c,n):g(n))||n);return a&&n&&H(e,c,n),n};let t=class extends z{constructor(){super(...arguments),this.covalentIcon=!1,this.filledIcon=!1,this.icon="",this.scale="body1",this.state="neutral",this.trailingIcon=!1,this._hasIconSlot=!1}checkIconSlot(){var e;const o=(e=this.shadowRoot)==null?void 0:e.querySelector('slot[name="icon"]');this._hasIconSlot=o&&o.assignedNodes().length>0}iconTemplate(){const o={"covalent-icon":this.covalentIcon,filled:this.filledIcon,hidden:this._hasIconSlot};return $`<slot name="icon"></slot>
      <cv-icon
        class=${f(o)}
    ...
    `}updated(o){super.updated(o),this.checkIconSlot()}};t.styles=[E`
      ${F(G)}
