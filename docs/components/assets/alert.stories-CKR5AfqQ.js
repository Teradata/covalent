import"./alert-rzGu-6Di.js";import"./query-assigned-elements-CymsZmtQ.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./foundation-CyC3Z9WI.js";import"./tslib.es6-B8g9kRRR.js";import"./foundation-Cb5KEIaQ.js";import"./class-map-DSF43RfV.js";import"./directive-CF8sV3Lr.js";import"./property-jaip2ZBL.js";import"./query-BNmDdGNL.js";const A={title:"Components/Alert",parameters:{layout:"padded"},argTypes:{state:{options:["neutral","active","positive","negative","caution"],control:{type:"select"}},actionElement:{options:["button","close icon","none"],control:{type:"select"}}},args:{title:"Alert title",description:"Alert description",state:"active",actionElement:"button"}},e=({title:u,description:m,state:i,icon:t,actionElement:o,inline:v})=>{switch(i){case"positive":t="check";break;case"negative":t="error";break;case"caution":t="warning";break;case"active":default:t="info"}return`
        <cv-alert
          titleText="${u}"
          descriptionText="${m}"
          state="${i}"
