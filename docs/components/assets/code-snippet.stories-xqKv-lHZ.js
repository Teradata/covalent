...
`,ke={title:"Components/Code snippet",args:{hideHeader:!1,inline:!1,label:"Example.sql",language:"sql",content:B,maxHeight:0}},h=({inline:t,content:e,hideHeader:n,label:r,language:o,maxHeight:a})=>(document.addEventListener("DOMContentLoaded",()=>{const i=document.querySelector("#theme-toggle");C.on(F,p=>{p?i.setAttribute("icon","brightness_high"):i.setAttribute("icon","brightness_4")}),i.addEventListener("click",()=>{C.emit(G)})},{once:!0}),`
  ...
  return \`
    ...
    \`;
}`,...(q=(I=c.parameters)==null?void 0:I.docs)==null?void 0:q.source}}};const Re=["Basic","Scrollable","HiddenHeader","Dialog"];export{s as Basic,c as Dialog,u as HiddenHeader,l as Scrollable,Re as __namedExportsOrder,ke as default};
