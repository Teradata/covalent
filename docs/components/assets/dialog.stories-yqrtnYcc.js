...
`,d=({})=>(document.addEventListener("DOMContentLoaded",()=>{const t=document.body.querySelectorAll("cv-button[data-num]");for(let l=0;l<t.length;l++){const i=t[l],n=i.dataset.num,c=(a=>function(){const r=document.body.querySelector("#dialog"+a);r.open=!0})(n);i.addEventListener("click",c)}window.toggleActions.onclick=function(){const l=document.body.querySelector("#dialog4"),i=document.body.querySelector("#hideActionVal"),n=!l.hideActions;l.hideActions=n,i.innerText=n};const o=document.querySelector("#dialog8"),e=document.querySelector("#dialog8-text-field");document.querySelector("#dialog8-primary-action-button").addEventListener("click",()=>{if(e.checkValidity()){o.close();return}e.reportValidity()})},{once:!0}),s),N={title:"Components/Dialog",tags:["autodocs"]},g=({trapFocus:t})=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#dialog-button").addEventListener("click",()=>{const e=document.body.querySelector("#dialog1");e.open=!0})},{once:!0}),`
