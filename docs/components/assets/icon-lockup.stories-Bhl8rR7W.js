import"./icon-lockup-dLfbQ98P.js";import"./circular-progress-LWZPy8Lw.js";import"./query-assigned-elements-BJdb4KNY.js";import"./state-CGn7W7VL.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./typography-Bxx1_gIs.js";import"./icon-BYPYUWym.js";import"./mwc-icon-BGUO1vKj.js";import"./tslib.es6-C-hQhb2A.js";import"./aria-property-BYXgNswj.js";import"./if-defined-dAx6j6jI.js";import"./style-map-CNNK6hz8.js";const M={title:"Components/Icon lockup",argTypes:{scale:{options:["headline1","headline2","headline3","headline4","headline5","headline6","subtitle1","subtitle2","button","caption","overline","body1","body2"],control:{type:"select"}},state:{options:["primary","positive","negative","caution",null],control:{type:"select"}}},args:{covalentIcon:!1,filledIcon:!1,icon:"houseboat",scale:"body1",state:"null",trailingIcon:!1}},a=({icon:s,scale:l,trailingIcon:i,state:p,covalentIcon:x,filledIcon:B})=>`<cv-icon-lockup icon="${s}" scale="${l}"${i?" trailingIcon":""}${x?" covalentIcon":""}${B?" filledIcon":""}${p?` state=${p}`:""}>Lorem ipsum dolor sit amet</cv-icon-lockup>`,N=({scale:s,trailingIcon:l,state:i})=>`<cv-icon-lockup scale="${s}"${l?" trailingIcon":""}${i?` state=${i}`:""}>Lorem ipsum dolor sit amet
