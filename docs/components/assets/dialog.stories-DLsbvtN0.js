...
`,d=({})=>(document.addEventListener("DOMContentLoaded",()=>{const o=document.body.querySelectorAll("cv-button[data-num]");for(let t=0;t<o.length;t++){const e=o[t],i=e.dataset.num,c=(a=>function(){const r=document.body.querySelector("#dialog"+a);r.open=!0})(i);e.addEventListener("click",c)}window.toggleActions.onclick=function(){const t=document.body.querySelector("#dialog4"),e=document.body.querySelector("#hideActionVal"),i=!t.hideActions;t.hideActions=i,e.innerText=i};const l=document.querySelector("#dialog8"),n=document.querySelector("#dialog8-text-field");document.querySelector("#dialog8-primary-action-button").addEventListener("click",()=>{if(n.checkValidity()){l.close();return}n.reportValidity()})},{once:!0}),s),_={title:"Components/Dialog"},g=()=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#dialog-button").addEventListener("click",()=>{const l=document.body.querySelector("#dialog1");l.open=!0})},{once:!0}),`
    ...
    </cv-dialog>`),H=d.bind({}),N=g.bind({}),y=({})=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#logout-button").addEventListener("click",()=>{const l=document.body.querySelector("#example-logout");l.open=!0})},{once:!0}),`
  ...
  <cv-dialog id="example-logout" heading="You will be logged out soon" scrimClickAction="">
          ...
          </cv-dialog>`),P=y.bind({}),x=({})=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#udf-button").addEventListener("click",()=>{const l=document.body.querySelector("#example-udf");l.open=!0})},{once:!0}),`
          ...
          <cv-dialog id="example-udf" heading="Delete User Defined Function" scrimClickAction="" >
            ...
            <cv-button slot="secondaryAction" dialogAction="close">Cancel</cv-button>
          </cv-dialog>`),j=x.bind({}),W=["Basic","Anatomy","Logout","UDF"];export{N as Anatomy,H as Basic,P as Logout,j as UDF,W as __namedExportsOrder,_ as default};
