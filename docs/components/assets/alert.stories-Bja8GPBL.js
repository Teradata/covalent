import"./alert-SClUx_Bq.js";import"./query-assigned-elements-DrVEbY-Z.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./foundation-_KiBCxiy.js";import"./tslib.es6-BHOXe2z4.js";import"./foundation-D9HcNlNd.js";import"./class-map-BiVinSLa.js";import"./directive-CvdRHFdJ.js";import"./property-jaip2ZBL.js";import"./query-BwR-Wesx.js";const A={title:"Components/Alert",parameters:{layout:"padded"},argTypes:{state:{options:["neutral","active","positive","negative","caution"],control:{type:"select"}},actionElement:{options:["button","close icon","none"],control:{type:"select"}}},args:{title:"Alert title",description:"Alert description",state:"active",actionElement:"button"}},e=({title:u,description:m,state:i,icon:t,actionElement:o,inline:v})=>{switch(i){case"positive":t="check";break;case"negative":t="error";break;case"caution":t="warning";break;case"active":default:t="info"}return`
        <cv-alert
          titleText="${u}"
          descriptionText="${m}"
          state="${i}"
