import{s as N,M as F}from"./select-D8egVPx4.js";import{r as A,i as I,e as R}from"./query-assigned-elements-TXvH8BPC.js";import"./button-DGgSiZo9.js";import"./list-item-BChjRDAn.js";import"./tslib.es6-C-hQhb2A.js";import"./mwc-line-ripple-directive-BRBtKntZ.js";import"./base-element-CYNOzLiN.js";import"./utils-DQt7ZoY7.js";import"./property-jaip2ZBL.js";import"./query-C-WWPLnw.js";import"./class-map-s1sGgw8A.js";import"./directive-CvdRHFdJ.js";import"./observer-D8jHVEI7.js";import"./state-C-wh0DpU.js";import"./style-map-BRLUR99k.js";import"./mwc-icon-BO_vOlXN.js";import"./form-element-DfOpRtaI.js";import"./event-options-DSmr0rIs.js";import"./if-defined-BRq_wxIY.js";import"./ripple-handlers-Y4T00Vej.js";import"./aria-property-BYXgNswj.js";import"./query-assigned-nodes-GkuzXdRo.js";const q=":host{--mdc-menu-item-height: calc(48px + var(--cv-density-mode, 0) * var(--cv-density-interval, 4px))}mwc-menu-surface{--mdc-theme-surface: var(--cv-theme-surface-container)}";var z=Object.getOwnPropertyDescriptor,G=(a,n,d,u)=>{for(var m=u>1?void 0:u?z(n,d):n,l=a.length-1,b;l>=0;l--)(b=a[l])&&(m=b(m)||m);return m};let v=class extends F{};v.styles=[N,I`
      ${A(q)}
    `];v=G([R("cv-menu")],v);const le={title:"Components/Menu",component:"cv-menu",parameters:{layout:"padded"},args:{corner:"BOTTOM_START",defaultFocus:"NONE",fixed:!0,activatable:!0},argTypes:{corner:{options:["TOP_START","TOP_END","BOTTOM_START","BOTTOM_END"],control:{type:"select"}},defaultFocus:{options:["NONE","LIST_ROOT","FIRST_ITEM","LAST_ITEM"],control:{type:"select"}},x:{control:{type:"number"}},y:{control:{type:"number"}},absolute:{control:{type:"boolean"}}}},e=a=>{document.addEventListener("DOMContentLoaded",()=>{window.basicMenu.anchor=window.basicButton,window.basicButton.addEventListener("click",function(){window.basicMenu.open=!window.basicMenu.open})});let n="";for(const[d,u]of Object.entries(a))n+=`${d}="${u}" `;return`
  ...
  \`;
}`,...(x=(j=r.parameters)==null?void 0:j.docs)==null?void 0:x.source}}};const ve=["Basic","absolute","quickOpen","fullwidth","stayOpenOnBodyClick","corner","defaultFocus"];export{e as Basic,ve as __namedExportsOrder,t as absolute,c as corner,le as default,r as defaultFocus,s as fullwidth,i as quickOpen,o as stayOpenOnBodyClick};
