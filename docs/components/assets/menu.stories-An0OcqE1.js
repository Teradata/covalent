import{s as x,M as F}from"./select-BnyTZaSB.js";import{i as A,r as I,e as R}from"./query-assigned-elements-XF8sHqwE.js";import"./button-BW6mrqUX.js";import"./list-item-O5WmSGjJ.js";import"./tslib.es6-CilhkYUw.js";import"./mwc-line-ripple-directive-B-78rPhj.js";import"./base-element-CGkZ9Caz.js";import"./utils-DQt7ZoY7.js";import"./query-BIWRq3i5.js";import"./class-map-j_UyOF6B.js";import"./directive-CF8sV3Lr.js";import"./observer-D8jHVEI7.js";import"./state-DigO7a43.js";import"./style-map-BvUKPc5V.js";import"./mwc-icon-BHr-cy3v.js";import"./form-element-BmV-oK_I.js";import"./event-options-C2Dj4usW.js";import"./if-defined-a0dakvOI.js";import"./ripple-handlers-CwFC0uxg.js";import"./aria-property-BYXgNswj.js";import"./query-assigned-nodes-B6dODpMo.js";const q="mwc-menu-surface{--mdc-theme-surface: var(--cv-theme-surface-container)}";var z=Object.defineProperty,G=Object.getOwnPropertyDescriptor,H=(d,n,s,i)=>{for(var t=i>1?void 0:i?G(n,s):n,l=d.length-1,v;l>=0;l--)(v=d[l])&&(t=(i?v(n,s,t):v(t))||t);return i&&t&&z(n,s,t),t};let b=class extends F{};b.styles=[x,A`
      ${I(q)}
    `];b=H([R("cv-menu")],b);const le={title:"Components/Menu",component:"cv-menu",parameters:{layout:"padded"},args:{corner:"BOTTOM_START",defaultFocus:"NONE",fixed:!0,activatable:!0},argTypes:{corner:{options:["TOP_START","TOP_END","BOTTOM_START","BOTTOM_END"],control:{type:"select"}},defaultFocus:{options:["NONE","LIST_ROOT","FIRST_ITEM","LAST_ITEM"],control:{type:"select"}},x:{control:{type:"number"}},y:{control:{type:"number"}},absolute:{control:{type:"boolean"}}}},e=d=>{document.addEventListener("DOMContentLoaded",()=>{window.basicMenu.anchor=window.basicButton,window.basicButton.addEventListener("click",function(){window.basicMenu.open=!window.basicMenu.open})});let n="";for(const[s,i]of Object.entries(d))n+=`${s}="${i}" `;return`
  ...
  \`;
}`,...(N=(j=m.parameters)==null?void 0:j.docs)==null?void 0:N.source}}};const ve=["Basic","absolute","quickOpen","fullwidth","stayOpenOnBodyClick","corner","defaultFocus"];export{e as Basic,ve as __namedExportsOrder,o as absolute,u as corner,le as default,m as defaultFocus,r as fullwidth,c as quickOpen,a as stayOpenOnBodyClick};
