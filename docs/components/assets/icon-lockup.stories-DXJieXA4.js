import"./icon-lockup-hzVnjaE6.js";import"./circular-progress-yvfMitWj.js";import"./query-assigned-elements-BJdb4KNY.js";import"./state-CGn7W7VL.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./typography-Cz0H0E8U.js";import"./icon-1XQe7S_h.js";import"./mwc-icon-ClXlKBjv.js";import"./tslib.es6-X4n3o5C8.js";import"./aria-property-BYXgNswj.js";import"./if-defined-dAx6j6jI.js";import"./style-map-CNNK6hz8.js";const M={title:"Components/Icon lockup",argTypes:{scale:{options:["headline1","headline2","headline3","headline4","headline5","headline6","subtitle1","subtitle2","button","caption","overline","body1","body2"],control:{type:"select"}},state:{options:["primary","positive","negative","caution",null],control:{type:"select"}}},args:{covalentIcon:!1,filledIcon:!1,icon:"houseboat",scale:"body1",state:"null",trailingIcon:!1},tags:["autodocs"]},a=({icon:s,scale:l,trailingIcon:i,state:p,covalentIcon:x,filledIcon:B})=>`<cv-icon-lockup icon="${s}" scale="${l}"${i?" trailingIcon":""}${x?" covalentIcon":""}${B?" filledIcon":""}${p?` state=${p}`:""}>Lorem ipsum dolor sit amet</cv-icon-lockup>`,N=({scale:s,trailingIcon:l,state:i})=>`<cv-icon-lockup scale="${s}"${l?" trailingIcon":""}${i?` state=${i}`:""}>Lorem ipsum dolor sit amet
