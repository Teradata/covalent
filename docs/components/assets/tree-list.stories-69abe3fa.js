...
`;var j=Object.defineProperty,H=Object.getOwnPropertyDescriptor,s=(e,i,r,n)=>{for(var t=n>1?void 0:n?H(i,r):i,o=e.length-1,a;o>=0;o--)(a=e[o])&&(t=(n?a(i,r,t):a(t))||t);return n&&t&&j(i,r,t),t};let l=class extends k{constructor(){super(...arguments),this.isOpen=!1,this.icon="",this.indentLevel=0,this.indentMultiple=16}render(){const e={hidden:!this.isOpen,visible:this.isOpen},i={open:this.isOpen,close:!this.isOpen},r="arrow_right",n=v`<cv-icon>${this.icon}</cv-icon>`,t=v`<cv-icon class="${y(i)} arrowIcon"
    ...
    `}_handleClick(){this.isOpen=!this.isOpen;const e=new CustomEvent("select",{detail:{message:`Emitting an event from ${this}`},bubbles:!0,composed:!0});this.dispatchEvent(e)}};l.styles=[z`
      ${O(N)}
    `];s([h({type:Boolean})],l.prototype,"isOpen",2);s([h({type:String})],l.prototype,"icon",2);s([h({type:Number})],l.prototype,"indentLevel",2);s([h({type:Number})],l.prototype,"indentMultiple",2);l=s([_("cv-tree-list-item")],l);const F={title:"Components/Tree List",args:{icon:"description"},parameters:{layout:"centered"}},c=({icon:e})=>`
        <cv-tree-list>
    ...
    `;var g,b,u;c.parameters={...c.parameters,docs:{...(g=c.parameters)==null?void 0:g.docs,source:{originalSource:`({
  icon
}) => {
  return \`
        <cv-tree-list>
    ...
    \`;
}`,...(u=(b=c.parameters)==null?void 0:b.docs)==null?void 0:u.source}}};var x,R,C;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`({
  icon
}) => {
  return \`
        <cv-tree-list>
    ...
    \`;
}`,...(C=(R=d.parameters)==null?void 0:R.docs)==null?void 0:C.source}}};var A,w,$;m.parameters={...m.parameters,docs:{...(A=m.parameters)==null?void 0:A.docs,source:{originalSource:`({
  icon
}) => {
  return \`
        <cv-tree-list>
    ...
    \`;
}`,...($=(w=m.parameters)==null?void 0:w.docs)==null?void 0:$.source}}};var L,P,D;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`({
  icon
}) => {
  return \`
        <div style="width: 300px; border-left: solid white 1px; border-right: solid white 1px">
    ...
    \`;
}`,...(D=(P=p.parameters)==null?void 0:P.docs)==null?void 0:D.source}}};const G=["TreeList","TwoLineItems","EmptyState","OverflowTest"];export{m as EmptyState,p as OverflowTest,c as TreeList,d as TwoLineItems,G as __namedExportsOrder,F as default};
//# sourceMappingURL=tree-list.stories-69abe3fa.js.map
