...
`,vt={title:"Components/Status Dialog",argTypes:{state:{options:["error","positive","warning"],control:{type:"select"}}},args:{state:"error",open:!1,hideActions:!1,heading:"Basic heading for the dialog"}},h=({state:t,hideActions:e,heading:o})=>(document.addEventListener("DOMContentLoaded",()=>{document.body.querySelector("#dialog-button").addEventListener("click",()=>{const c=document.body.querySelector("#dialog");c.open=!0})},{once:!0}),`
...
}`,...(O=(E=u.parameters)==null?void 0:E.docs)==null?void 0:O.source}}};const bt=["Basic","Positive","Warning","Error","WithDetails"];export{m as Basic,g as Error,r as Positive,l as Warning,u as WithDetails,bt as __namedExportsOrder,vt as default};
