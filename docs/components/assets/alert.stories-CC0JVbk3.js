import"./alert-HgKk-GbN.js";import"./query-assigned-elements-BJdb4KNY.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./foundation-_KiBCxiy.js";import"./tslib.es6-BHOXe2z4.js";import"./foundation-D9HcNlNd.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./state-CGn7W7VL.js";import"./query-pFbEai1B.js";import"./icon-BYm93zaG.js";import"./mwc-icon-BZDiTMPV.js";const h={title:"Components/Alert",parameters:{layout:"padded"},argTypes:{state:{options:["neutral","active","positive","negative","caution"],control:{type:"select"}},actionElement:{options:["button","close icon","none"],control:{type:"select"}},inline:{control:{type:"boolean"}}},args:{icon:"info",state:"neutral",inline:!1,titleText:"Alert title",iconAriaLabel:"aria-label for the icon",descriptionText:"Alert description",actionElement:"button"},tags:["autodocs"]},$=({icon:r,state:o,inline:v,titleText:n,iconAriaLabel:i,descriptionText:a,actionElement:s})=>`
        <cv-alert
          ${r?`icon="${r}"`:""}
          ${o?`state="${o}"`:""}
          ${v?"inline":""}
