import{n as m,s as Y,x as E,i as D,r as B,e as R}from"./query-assigned-elements-XF8sHqwE.js";import{o as q}from"./class-map-j_UyOF6B.js";import"./icon-D16dCIBT.js";import"./circular-progress-lUGui0Yj.js";import"./directive-CF8sV3Lr.js";import"./mwc-icon-BHr-cy3v.js";import"./tslib.es6-CilhkYUw.js";import"./aria-property-BYXgNswj.js";import"./if-defined-a0dakvOI.js";import"./style-map-BvUKPc5V.js";var F=Object.defineProperty,x=(a,e,s,r)=>{for(var t=void 0,n=a.length-1,c;n>=0;n--)(c=a[n])&&(t=c(e,s,t)||t);return t&&F(e,s,t),t};class b extends Y{constructor(){super(...arguments),this.state="neutral",this.statusText="",this.statusHelper="",this.titleText=""}render(){const e={active:this.state==="active",caution:this.state==="caution",error:this.state==="error",positive:this.state==="positive"};return E`
