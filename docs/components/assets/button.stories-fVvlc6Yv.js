import"./button-_PqhMK-p.js";import"./query-assigned-elements-BJdb4KNY.js";import"./tslib.es6-X4n3o5C8.js";import"./mwc-icon-ClXlKBjv.js";import"./ripple-handlers-_TDZG32v.js";import"./base-element-BG6oFIG9.js";import"./utils-sZhlDiu_.js";import"./state-CGn7W7VL.js";import"./query-pFbEai1B.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./style-map-CNNK6hz8.js";import"./aria-property-BYXgNswj.js";import"./event-options-CZVCfsC0.js";import"./if-defined-dAx6j6jI.js";const cn={title:"Components/Button",args:{label:"Button",icon:"houseboat",showIcon:!1,trailingIcon:!1,disabled:!1,dense:!1},argTypes:{style:{options:["raised","outlined"],control:{type:"select"}},color:{options:["primary","secondary","emphasis","positive","negative","caution"],control:{type:"select"}}},tags:["autodocs"]},n=({label:J,showIcon:d,trailingIcon:K,icon:$,style:L,color:b,disabled:M,dense:N})=>`<cv-button id="myButton"
                      label="${J}"
                      ${d&&K?"trailingIcon":""}
                      ${d&&$?`icon="${$}"`:""}
                      ${N?"dense":""}
