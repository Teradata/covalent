import"./checkbox-DIX8KeUK.js";import"./formfield-lphfJpmF.js";import{Basic as x}from"./typography.stories-D4l3IOE2.js";import{l as g}from"./lorem-ipsum.content-ttJlmQjQ.js";import{t as T}from"./table-progress-indicator.content-Ct_3biMo.js";const _={title:"Components/Skeleton"},r="skeleton-text",o="skeleton-effect-fade",t=()=>{const e=document.createElement("div");e.innerHTML=T;const l=e.getElementsByClassName("mdc-data-table__cell");return Array.from(l).forEach(n=>{n.classList.add(r),n.classList.add(o)}),e},c=()=>{const e=document.createElement("div");return e.classList.add(r),e.classList.add(o),e.innerHTML=`${x()}`,e},a=()=>{const e=document.createElement("div");return e.classList.add(r),e.classList.add(o),e.innerHTML=g,e},s=({label:e="Bananas",indeterminate:l})=>{const n=document.createElement("div");n.innerHTML=`
      <style>
          cv-formfield {
              display: block;
          }
