import{s as j,x as E,n as m,r as D,i as B,e as R}from"./query-assigned-elements-BJdb4KNY.js";import{o as q}from"./class-map-LmxYoNzI.js";import"./icon-1XQe7S_h.js";import"./circular-progress-yvfMitWj.js";import"./directive-CvdRHFdJ.js";import"./mwc-icon-ClXlKBjv.js";import"./tslib.es6-X4n3o5C8.js";import"./aria-property-BYXgNswj.js";import"./if-defined-dAx6j6jI.js";import"./style-map-CNNK6hz8.js";var F=Object.defineProperty,g=(a,e,r,n)=>{for(var t=void 0,s=a.length-1,c;s>=0;s--)(c=a[s])&&(t=c(e,r,t)||t);return t&&F(e,r,t),t};class b extends j{constructor(){super(...arguments),this.state="neutral",this.statusText="",this.statusHelper="",this.titleText=""}render(){const e={active:this.state==="active",caution:this.state==="caution",error:this.state==="error",positive:this.state==="positive"};return E`
    ...
    `];x=K([R("cv-status-header")],x);const N=":host{--cv-status-header-item-width: 178px;display:flex;padding:14px 16px;align-items:center;font-family:var(--mdc-typography-body2-font-family);font-size:var(--mdc-typography-body2-font-size);font-weight:var(--mdc-typography-body2-font-weight);line-height:var(--mdc-typography-body2-line-height)}span{display:inline-block;width:var(--cv-status-header-item-width);color:var(--mdc-theme-text-secondary-on-background)}";var Q=Object.defineProperty,U=Object.getOwnPropertyDescriptor,W=(a,e,r,n)=>{for(var t=n>1?void 0:n?U(e,r):e,s=a.length-1,c;s>=0;s--)(c=a[s])&&(t=(n?c(e,r,t):c(t))||t);return n&&t&&Q(e,r,t),t};let p=class extends j{render(){return E`<span>${this.label}</span> <slot></slot>`}};p.styles=[B`
      ${D(N)}
    `];W([m()],p.prototype,"label",2);p=W([R("cv-status-header-item")],p);const it={title:"Components/Status Header",parameters:{layout:"fullscreen"},argTypes:{state:{options:["active","caution","error","positive","neutral"],control:{type:"select"}}},args:{state:"neutral",title:"Item details",status:"Status",icon:"Status"},tags:["autodocs"]},V=(a,e)=>a==="active"?'<cv-circular-progress slot="status-header-icon" indeterminate density="-2"></cv-circular-progress>':a==="pending"?'<cv-icon slot="status-header-icon" class="covalent-icon">loader_dots</cv-icon>':`<cv-icon slot="status-header-icon">${e}</cv-icon>`,o=({state:a="neutral",status:e="status",title:r="title",icon:n})=>`
...
}`,...(P=(f=i.parameters)==null?void 0:f.docs)==null?void 0:P.source}}};var T,$,S;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`({
  state = 'neutral',
  status = 'status',
  title = 'title',
  icon
...
}`,...(Y=(L=v.parameters)==null?void 0:L.docs)==null?void 0:Y.source}}};const lt=["Active","Caution","Error","Positive","Paused","Pending"];export{i as Active,l as Caution,d as Error,h as Paused,v as Pending,u as Positive,lt as __namedExportsOrder,it as default};
