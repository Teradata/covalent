import"./button-DegqevOX.js";import"./query-assigned-elements-BJdb4KNY.js";import"./tslib.es6-BHOXe2z4.js";import"./mwc-icon-BZDiTMPV.js";import"./ripple-handlers-CbzjdAP9.js";import"./base-element-C3CkHPn4.js";import"./utils-DQt7ZoY7.js";import"./state-CGn7W7VL.js";import"./query-pFbEai1B.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./style-map-CNNK6hz8.js";import"./aria-property-BYXgNswj.js";import"./event-options-CZVCfsC0.js";import"./if-defined-dAx6j6jI.js";const pe={title:"Components/Button",args:{label:"Button",icon:"houseboat",showIcon:!1,trailingIcon:!1,disabled:!1,dense:!1,raised:!1,unelevated:!1,outlined:!1,expandContent:!1,fullwidth:!1},argTypes:{color:{options:["primary","secondary","emphasis","positive","negative","caution"],control:{type:"select"}}},tags:["autodocs"]},e=({label:H,showIcon:p,trailingIcon:J,icon:u,color:m,disabled:K,dense:L,raised:M,unelevated:N,outlined:P,expandContent:Q,fullwidth:U})=>`<cv-button id="myButton"
                      label="${H}"
                      ${p&&J?"trailingIcon":""}
                      ${p&&u?`icon="${u}"`:""}
                      ${L?"dense":""}
