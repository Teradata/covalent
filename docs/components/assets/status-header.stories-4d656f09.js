...
`;var V=Object.defineProperty,X=Object.getOwnPropertyDescriptor,W=(s,e,r,a)=>{for(var t=a>1?void 0:a?X(e,r):e,n=s.length-1,c;n>=0;n--)(c=s[n])&&(t=(a?c(e,r,t):c(t))||t);return a&&t&&V(e,r,t),t};let p=class extends Y{render(){return D`<span>${this.label}</span> <slot></slot>`}};p.styles=[E`
      ${B(U)}
    `];W([m()],p.prototype,"label",2);p=W([R("cv-status-header-item")],p);const st={title:"Components/Status Header",parameters:{layout:"fullscreen"},argTypes:{state:{options:["active","caution","error","positive","neutral"],control:{type:"select"}}},args:{state:"neutral",title:"Item details",status:"Status",icon:"Status"}},Z=(s,e)=>s==="active"?'<cv-circular-progress slot="status-header-icon" indeterminate density="-2"></cv-circular-progress>':s==="pending"?'<cv-icon slot="status-header-icon" class="covalent-icon">loader_dots</cv-icon>':`<cv-icon slot="status-header-icon">${e}</cv-icon>`,o=({state:s="neutral",status:e,title:r,icon:a})=>`
    <cv-status-header state="${s}" statusText="${e}" statusHelper="Status" titleText="${r}">
      ${Z(s,a)}
    ...
    </cv-status-header>`,i=o.bind({});i.args={state:"active",status:"Running",title:"Active item details"};const l=o.bind({});l.args={state:"caution",icon:"warning",status:"Caution",title:"Caution item details"};const u=o.bind({});u.args={state:"error",icon:"error",status:"Error",title:"Error item details"};const d=o.bind({});d.args={state:"positive",icon:"done",status:"Positive",title:"Positive item details"};const h=o.bind({});h.args={icon:"pause",status:"Paused",title:"Paused item details"};const v=o.bind({});v.args={state:"pending",status:"Pending",title:"Pending item details"};var f,y,P;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`({
  state = 'neutral',
  status,
  title,
  icon
...
}`,...(P=(y=i.parameters)==null?void 0:y.docs)==null?void 0:P.source}}};var T,$,S;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`({
  state = 'neutral',
  status,
  title,
  icon
...
}`,...(S=($=l.parameters)==null?void 0:$.docs)==null?void 0:S.source}}};var w,C,_;u.parameters={...u.parameters,docs:{...(w=u.parameters)==null?void 0:w.docs,source:{originalSource:`({
  state = 'neutral',
  status,
  title,
  icon
...
}`,...(_=(C=u.parameters)==null?void 0:C.docs)==null?void 0:_.source}}};var H,I,M;d.parameters={...d.parameters,docs:{...(H=d.parameters)==null?void 0:H.docs,source:{originalSource:`({
  state = 'neutral',
  status,
  title,
  icon
...
}`,...(M=(I=d.parameters)==null?void 0:I.docs)==null?void 0:M.source}}};var O,A,z;h.parameters={...h.parameters,docs:{...(O=h.parameters)==null?void 0:O.docs,source:{originalSource:`({
  state = 'neutral',
  status,
  title,
  icon
...
}`,...(L=(k=v.parameters)==null?void 0:k.docs)==null?void 0:L.source}}};const rt=["Active","Caution","Error","Positive","Paused","Pending"];export{i as Active,l as Caution,u as Error,h as Paused,v as Pending,d as Positive,rt as __namedExportsOrder,st as default};
//# sourceMappingURL=status-header.stories-4d656f09.js.map
