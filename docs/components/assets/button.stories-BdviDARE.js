import"./button-BW6mrqUX.js";import"./query-assigned-elements-XF8sHqwE.js";import"./tslib.es6-CilhkYUw.js";import"./mwc-icon-BHr-cy3v.js";import"./ripple-handlers-CwFC0uxg.js";import"./base-element-CGkZ9Caz.js";import"./utils-DQt7ZoY7.js";import"./state-DigO7a43.js";import"./query-BIWRq3i5.js";import"./class-map-j_UyOF6B.js";import"./directive-CF8sV3Lr.js";import"./style-map-BvUKPc5V.js";import"./aria-property-BYXgNswj.js";import"./event-options-C2Dj4usW.js";import"./if-defined-a0dakvOI.js";const cn={title:"Components/Button",args:{label:"Button",icon:"houseboat",showIcon:!1,trailingIcon:!1,disabled:!1,dense:!1},argTypes:{style:{options:["raised","outlined"],control:{type:"select"}},color:{options:["primary","secondary","emphasis","positive","negative","caution"],control:{type:"select"}}}},n=({label:J,showIcon:d,trailingIcon:K,icon:$,style:L,color:b,disabled:M,dense:N})=>`<cv-button id="myButton"
                      label="${J}"
                      ${d&&K?"trailingIcon":""}
                      ${d&&$?`icon="${$}"`:""}
                      ${N?"dense":""}
