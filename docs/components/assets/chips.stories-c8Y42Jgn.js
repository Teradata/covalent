import{n as r,s as G,x as h,i as V,r as U,e as Y}from"./query-assigned-elements-XF8sHqwE.js";import{a as W}from"./utils-DQt7ZoY7.js";import{M as H,a as J,b as I,c as K,d as Q,e as d,f as X}from"./announce-Bgx9IB_V.js";import{i as q}from"./query-BIWRq3i5.js";import{o as Z}from"./class-map-j_UyOF6B.js";import"./tslib.es6-B8g9kRRR.js";import"./keyboard-BGS45BWM.js";import"./foundation-Cb5KEIaQ.js";import"./component-yoLonR2Y.js";import"./_commonjsHelpers-BosuxZz1.js";import"./directive-CF8sV3Lr.js";var ii=Object.defineProperty,l=(n,i,t,o)=>{for(var e=void 0,c=n.length-1,a;c>=0;c--)(a=n[c])&&(e=a(i,t,e)||e);return e&&ii(i,t,e),e};let ti=0;class p extends G{constructor(){super(),this.mdcFoundationClass=H,this.label="",this.icon="",this.trailingIcon=!1,this.avatar=!1,this.disabled=!1,this.filter=!1,this.chipId=ti++}render(){const i={"mdc-evolution-chip":!0,"mdc-evolution-chip--disabled":this.disabled,"mdc-evolution-chip--with-trailing-action":this.trailingIcon,"mdc-evolution-chip--with-primary-graphic":!this.trailingIcon&&this.icon,"mdc-evolution-chip--with-primary-icon":this.icon&&!this.filter,"mdc-evolution-chip--filter":this.filter,"mdc-evolution-chip--selectable":this.filter,"mdc-evolution-chip--with-avatar":this.avatar,secondary:this.state==="secondary",positive:this.state==="positive",negative:this.state==="negative",caution:this.state==="caution"};return h`
    ...
    >
      ...
      ${U(ri)}
    `];x=di([Y("cv-chip-set")],x);const Ii={title:"Components/Chips",args:{label:"Chip",icon:"houseboat",showIcon:!1,trailingIcon:!1,disabled:!1,avatar:!1}},b=({avatar:n,label:i,disabled:t,icon:o,showIcon:e,state:c,trailingIcon:a})=>`<cv-chip-set label="test chips">
           <cv-chip
                label="${i}"
                ${e?`icon="${o}"`:""}
                ${e&&a?"trailingIcon":""}
...
}`,...(j=(L=g.parameters)==null?void 0:L.docs)==null?void 0:j.source}}};const $i=["Basic","Secondary","Caution","Positive","Negative","Selectable"];export{y as Basic,u as Caution,_ as Negative,v as Positive,m as Secondary,g as Selectable,$i as __namedExportsOrder,Ii as default};
