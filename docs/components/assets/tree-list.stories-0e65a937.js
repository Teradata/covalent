...
`;var H=Object.defineProperty,V=Object.getOwnPropertyDescriptor,s=(e,n,r,i)=>{for(var t=i>1?void 0:i?V(n,r):n,a=e.length-1,o;a>=0;a--)(o=e[a])&&(t=(i?o(n,r,t):o(t))||t);return i&&t&&H(n,r,t),t};let l=class extends _{constructor(){super(...arguments),this.isOpen=!1,this.icon="",this.indentLevel=0,this.indentMultiple=16}render(){const e={hidden:!this.isOpen,visible:this.isOpen},n={open:this.isOpen,close:!this.isOpen},r="arrow_right",i=v`<cv-icon>${this.icon}</cv-icon>`,t=v`<cv-icon class="${g(n)} arrowIcon"
      >${r}</cv-icon
    >`;return v`
      <div
