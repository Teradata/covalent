...
`;var di=Object.defineProperty,hi=Object.getOwnPropertyDescriptor,si=(a,i,t,o)=>{for(var e=o>1?void 0:o?hi(i,t):i,c=a.length-1,n;c>=0;c--)(n=a[c])&&(e=(o?n(i,t,e):n(e))||e);return o&&e&&di(i,t,e),e};let x=class extends s{};x.styles=[V`
      ${U(li)}
    `];x=si([Y("cv-chip-set")],x);const ki={title:"Components/Chips",args:{label:"Chip",icon:"houseboat",showIcon:!1,trailingIcon:!1,disabled:!1,avatar:!1}},b=({avatar:a,label:i,disabled:t,icon:o,showIcon:e,state:c,trailingIcon:n})=>`<cv-chip-set label="test chips">
           <cv-chip
                label="${i}"
                ${e?`icon="${o}"`:""}
                ${e&&n?"trailingIcon":""}
...
}`,...(L=(j=g.parameters)==null?void 0:j.docs)==null?void 0:L.source}}};const Ai=["Basic","Secondary","Caution","Positive","Negative","Selectable"];export{y as Basic,u as Caution,_ as Negative,v as Positive,m as Secondary,g as Selectable,Ai as __namedExportsOrder,ki as default};
