...
`;var J=Object.defineProperty,K=Object.getOwnPropertyDescriptor,g=(o,n,i,e)=>{for(var t=e>1?void 0:e?K(n,i):n,s=o.length-1,u;s>=0;s--)(u=o[s])&&(t=(e?u(n,i,t):u(t))||t);return e&&t&&J(n,i,t),t};let r=class extends G{constructor(){super(...arguments),this.headline="",this.subtitle="",this.icon="",this.card=!1}render(){return c`
    ...
    `}};r.styles=[q`
      ${F(I)}
    `];g([f({type:String})],r.prototype,"headline",2);g([f({type:String})],r.prototype,"subtitle",2);g([f({type:String})],r.prototype,"icon",2);g([f({type:Boolean})],r.prototype,"card",2);r=g([H("cv-empty-state")],r);const tt={title:"Components/Empty state",args:{headline:"You don't have access to this area",subtitle:`You don't have permission to view this application.
Please contact your system administrator for further details.`,action:!1,twoActions:!0,icon:"work"}},a=({headline:o,subtitle:n,action:i,twoActions:e,icon:t})=>`
  ...
  \`;
}`,...(D=(E=d.parameters)==null?void 0:E.docs)==null?void 0:D.source}}};const et=["Page","PageTitleOnly","PageWithSubtitle","PageOneAction","PageTwoActions","CardNoAction","CardWithAction"];export{y as CardNoAction,d as CardWithAction,a as Page,l as PageOneAction,h as PageTitleOnly,p as PageTwoActions,m as PageWithSubtitle,et as __namedExportsOrder,tt as default};
//# sourceMappingURL=empty-state.stories-1d64d958.js.map
