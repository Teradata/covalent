import"./button-c60ecbef.js";import"./query-assigned-elements-9f88bee1.js";import"./tslib.es6-6921e62d.js";import"./mwc-icon-4afc0ea5.js";import"./ripple-handlers-32cb331f.js";import"./base-element-cae00a28.js";import"./utils-529e1a6d.js";import"./property-f36ea729.js";import"./state-2a0073ff.js";import"./query-3e91a3b8.js";import"./class-map-018c3a6a.js";import"./style-map-4c420736.js";import"./aria-property-3dc182ec.js";import"./event-options-b5830ec0.js";import"./if-defined-c3862b86.js";const cn={title:"Components/Button",args:{label:"Button",icon:"houseboat",showIcon:!1,trailingIcon:!1,disabled:!1,dense:!1},argTypes:{style:{options:["raised","outlined"],control:{type:"select"}},color:{options:["primary","secondary","emphasis","positive","negative","caution"],control:{type:"select"}}}},n=({label:J,showIcon:d,trailingIcon:K,icon:$,style:L,color:b,disabled:M,dense:N})=>`<cv-button id="myButton"
                      label="${J}"
                      ${d&&K?"trailingIcon":""}
                      ${d&&$?`icon="${$}"`:""}
                      ${N?"dense":""}
