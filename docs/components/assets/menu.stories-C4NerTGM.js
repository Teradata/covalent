import{s as x,M as F}from"./select-BCseAaxy.js";import{r as A,i as I,e as R}from"./query-assigned-elements-BJdb4KNY.js";import"./button-CkdChyb2.js";import"./list-item-CGSPpq60.js";import"./tslib.es6-C-hQhb2A.js";import"./mwc-line-ripple-directive-CtRFQWit.js";import"./base-element-C3CkHPn4.js";import"./utils-DQt7ZoY7.js";import"./query-pFbEai1B.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./observer-D8jHVEI7.js";import"./state-CGn7W7VL.js";import"./style-map-CNNK6hz8.js";import"./mwc-icon-BGUO1vKj.js";import"./form-element-BmZ4g8Y6.js";import"./event-options-CZVCfsC0.js";import"./if-defined-dAx6j6jI.js";import"./ripple-handlers-CLC5WHP1.js";import"./aria-property-BYXgNswj.js";import"./query-assigned-nodes-BxERp_Ow.js";const q="mwc-menu-surface{--mdc-theme-surface: var(--cv-theme-surface-container)}";var z=Object.getOwnPropertyDescriptor,G=(a,n,d,u)=>{for(var m=u>1?void 0:u?z(n,d):n,l=a.length-1,b;l>=0;l--)(b=a[l])&&(m=b(m)||m);return m};let v=class extends F{};v.styles=[x,I`
      ${A(q)}
  ...
  \`;
}`,...($=(P=s.parameters)==null?void 0:P.docs)==null?void 0:$.source}}};var E,T,h;o.parameters={...o.parameters,docs:{...(E=o.parameters)==null?void 0:E.docs,source:{originalSource:`args => {
  document.addEventListener('DOMContentLoaded', () => {
    window.basicMenu.anchor = window.basicButton;
    window.basicButton.addEventListener('click', function () {
      window.basicMenu.open = !window.basicMenu.open;
  ...
  \`;
}`,...(h=(T=o.parameters)==null?void 0:T.docs)==null?void 0:h.source}}};var _,C,S;c.parameters={...c.parameters,docs:{...(_=c.parameters)==null?void 0:_.docs,source:{originalSource:`args => {
  document.addEventListener('DOMContentLoaded', () => {
    window.basicMenu.anchor = window.basicButton;
    window.basicButton.addEventListener('click', function () {
      window.basicMenu.open = !window.basicMenu.open;
  ...
  \`;
}`,...(S=(C=c.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};var D,j,N;r.parameters={...r.parameters,docs:{...(D=r.parameters)==null?void 0:D.docs,source:{originalSource:`args => {
  document.addEventListener('DOMContentLoaded', () => {
    window.basicMenu.anchor = window.basicButton;
    window.basicButton.addEventListener('click', function () {
      window.basicMenu.open = !window.basicMenu.open;
  ...
  \`;
}`,...(N=(j=r.parameters)==null?void 0:j.docs)==null?void 0:N.source}}};const le=["Basic","absolute","quickOpen","fullwidth","stayOpenOnBodyClick","corner","defaultFocus"];export{e as Basic,le as __namedExportsOrder,t as absolute,c as corner,de as default,r as defaultFocus,s as fullwidth,i as quickOpen,o as stayOpenOnBodyClick};
