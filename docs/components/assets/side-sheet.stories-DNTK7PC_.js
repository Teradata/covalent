import{r as _,i as L,n as u,e as O}from"./query-assigned-elements-BJdb4KNY.js";import{s as E,a as q}from"./dialog--F__cg2q.js";import"./button-DegqevOX.js";import{Active as C}from"./status-header.stories-CUgNVfmb.js";import{t as $}from"./table-row-selection.content-tSLjFSBa.js";/* empty css                           */import"./tslib.es6-BHOXe2z4.js";import"./inert.esm-CIOG4SQk.js";import"./base-element-C3CkHPn4.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./query-pFbEai1B.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./mwc-icon-BZDiTMPV.js";import"./ripple-handlers-CbzjdAP9.js";import"./state-CGn7W7VL.js";import"./style-map-CNNK6hz8.js";import"./aria-property-BYXgNswj.js";import"./event-options-CZVCfsC0.js";import"./if-defined-dAx6j6jI.js";import"./icon-BYm93zaG.js";import"./circular-progress-DMQgbjK5.js";const x=":host{--cv-side-sheet-width: 800px;--mdc-dialog-heading-ink-color: var(--mdc-theme-text-primary-on-background);--mdc-theme-surface: var(--cv-theme-surface)}.mdc-dialog{justify-content:flex-end}.mdc-dialog .mdc-dialog__surface{border-radius:0;height:100%;min-height:inherit;max-height:inherit;min-width:var(--cv-side-sheet-width, 400px)}.mdc-dialog--opening .mdc-dialog__container{transform:translate(100%);transition:transform .15s cubic-bezier(.4,0,1,1)}.mdc-dialog--open .mdc-dialog__container{transform:translate(0)}.mdc-dialog--closing .mdc-dialog__container{opacity:1;transform:translate(100%);transition:transform .15s cubic-bezier(0,0,.2,1)}:host([pushed]) .mdc-dialog__surface{min-width:100vw}:host([noPadding]) .mdc-dialog .mdc-dialog__content{padding:0}";var P=Object.defineProperty,D=Object.getOwnPropertyDescriptor,a=(n,e,t,i)=>{for(var o=i>1?void 0:i?D(e,t):e,h=n.length-1,l;h>=0;h--)(l=n[h])&&(o=(i?l(e,t,o):l(o))||o);return i&&o&&P(e,t,o),o};let s=class extends q{constructor(){super(),this.pushed=!1,this.noPadding=!1,this.width=800,this.hideActions=!0}willUpdate(n){super.willUpdate(n),n.has("width")&&(this.width!==800?this.style.setProperty("--cv-side-sheet-width",`${this.width}px`):this.style.removeProperty("--cv-side-sheet-width"))}};s.styles=[E,L`
      ${_(x)}
