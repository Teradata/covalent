import{r as L,i as S,e as B}from"./query-assigned-elements-BJdb4KNY.js";import{s as D,R as O}from"./mwc-radio.css-CqRL5et0.js";import"./formfield-lphfJpmF.js";import"./tslib.es6-BHOXe2z4.js";import"./ripple-handlers-CbzjdAP9.js";import"./base-element-C3CkHPn4.js";import"./utils-DQt7ZoY7.js";import"./state-CGn7W7VL.js";import"./query-pFbEai1B.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./style-map-CNNK6hz8.js";import"./aria-property-BYXgNswj.js";import"./form-element-BQMFi4zf.js";import"./observer-D8jHVEI7.js";import"./event-options-CZVCfsC0.js";import"./if-defined-dAx6j6jI.js";import"./query-assigned-nodes-BxERp_Ow.js";const j=":host{--mdc-radio-unchecked-color: var(--cv-theme-on-surface-variant);--mdc-theme-secondary: var(--cv-theme-primary);--mdc-radio-disabled-color: var(--cv-theme-on-surface-38);--mdc-ripple-hover-state-layer-color: var(--cv-theme-on-surface);--mdc-ripple-hover-state-layer-opacity: .08;--mdc-ripple-focus-state-layer-opacity: .12;--mdc-ripple-pressed-state-layer-opacity: .12}:host([checked]){--mdc-ripple-hover-state-layer-color: var(--cv-theme-primary);--mdc-ripple-hover-state-layer-opacity: .08;--mdc-ripple-focus-state-layer-opacity: .12;--mdc-ripple-pressed-state-layer-opacity: .12}:host(:focus-within:not([checked])){--mdc-radio-unchecked-color: var(--cv-theme-on-surface)}";var w=Object.getOwnPropertyDescriptor,P=(c,e,d,t)=>{for(var r=t>1?void 0:t?w(e,d):e,a=c.length-1,o;a>=0;a--)(o=c[a])&&(r=o(r)||r);return r};let u=class extends O{constructor(){super(...arguments),this.useStateLayerCustomProperties=!0}};u.styles=[D,S`
      ${L(j)}
