...
`;var C=Object.defineProperty,j=Object.getOwnPropertyDescriptor,d=(o,c,e,r)=>{for(var i=r>1?void 0:r?j(c,e):c,l=o.length-1,s;l>=0;l--)(s=o[l])&&(i=(r?s(c,e,i):s(i))||i);return r&&i&&C(c,e,i),i};let t=class extends ${constructor(){super(...arguments),this.width="200",this.height="160",this.iconOnly=!1}render(){const o={checked:this.checked,cornerFill:this.checked},c={showCheck:this.checked},e={"--width":this.width=="fill"?"100%":`${this.width}px`,"--height":`${this.height}px`};return v`
    ...
    <div style="width:600px; display:flex; border:solid 1px var(--mdc-theme-border); padding: 16px 0px; justify-content: center; gap:16px;">
      <cv-checkbox-icon width=${o} height=${c} ${e?" iconOnly":""}>
  ...
  `,B=({width:o,height:c,iconOnly:e})=>`
    <div class="mdc-layout-grid">
      <div class="mdc-layout-grid__inner">
        <cv-checkbox-icon width=${o} height=${c} ${e?"iconOnly":""} class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4">
  ...
  `,n=B.bind({});n.args={width:"105",height:"100"};var m,g,y;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`({
  width,
  height,
  iconOnly
}) => {
  return \`
    <div style="width:600px; display:flex; border:solid 1px var(--mdc-theme-border); padding: 16px 0px; justify-content: center; gap:16px;">
      <cv-checkbox-icon width=\${width} height=\${height} \${iconOnly ? ' iconOnly' : ''}>
        <cv-icon slot="icon">work</cv-icon>
        <div slot="text">Balanced</div>
        <div slot="text">Every week</div>
      </cv-checkbox-icon>
  ...
  \`;
}`,...(y=(g=a.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var f,x,u;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`({
  width,
  height,
  iconOnly
}) => {
  return \`
    <div class="mdc-layout-grid">
      <div class="mdc-layout-grid__inner">
        <cv-checkbox-icon width=\${width} height=\${height} \${iconOnly ? 'iconOnly' : ''} class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4">
          <cv-icon slot="icon">storage</cv-icon>
          <div slot="text">Data</div>
        </cv-checkbox-icon>
        <cv-checkbox-icon width=\${width} height=\${height} \${iconOnly ? 'iconOnly' : ''} class="mdc-layout-grid__cell mdc-layout-grid__cell--span-4">
  ...
  \`;
}`,...(u=(x=n.parameters)==null?void 0:x.docs)==null?void 0:u.source}}};const Q=["Template","WithGrid"];export{a as Template,n as WithGrid,Q as __namedExportsOrder,L as default};
//# sourceMappingURL=icon-checkbox.stories-28d9a5ed.js.map
