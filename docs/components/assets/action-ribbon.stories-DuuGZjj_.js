import"./action-ribbon-TH86zxPD.js";import"./button-C8Dr7l4U.js";import"./icon-BYm93zaG.js";import"./icon-button-CeuGj9q1.js";import"./query-assigned-elements-BJdb4KNY.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./foundation-_KiBCxiy.js";import"./tslib.es6-BHOXe2z4.js";import"./foundation-D9HcNlNd.js";import"./class-map-LmxYoNzI.js";import"./directive-CvdRHFdJ.js";import"./query-pFbEai1B.js";import"./mwc-icon-BZDiTMPV.js";import"./ripple-handlers-CbzjdAP9.js";import"./base-element-C3CkHPn4.js";import"./state-CGn7W7VL.js";import"./style-map-CNNK6hz8.js";import"./aria-property-BYXgNswj.js";import"./event-options-CZVCfsC0.js";import"./if-defined-dAx6j6jI.js";import"./mwc-icon-button.css-DLV-hkFx.js";const ve={title:"Components/Action Ribbon",parameters:{layout:"fullscreen"},argTypes:{labelText:{control:"text"},state:{control:"select",options:["active","negative","positive","caution"]},icon:{control:"text"},iconAriaLabel:{control:"text"},centered:{control:"boolean"}},tags:["autodocs"]},t=({labelText:r="No changes",state:e,icon:n,iconAriaLabel:p,centered:H=!1,saveDisabled:J=!1})=>`
    <cv-action-ribbon
      labelText="${r}"
      ${e?`state="${e}"`:""}
      ${n?`icon="${n}"`:""}
