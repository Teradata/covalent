import{x as h,i as b,r as p,e as f}from"./query-assigned-elements-DrVEbY-Z.js";import{n as m}from"./property-jaip2ZBL.js";import{C as y}from"./dialog-C4t-v-qD.js";import"./focused-page-D9u46BZH.js";import"./button-DL8Q-BuB.js";import"./toolbar-BD1Q5Z1V.js";import"./icon-button-C19p1m3Z.js";import"./icon-button-toggle-B3z3MppX.js";import"./icon-radio-toggle-vGTPOWGp.js";import"./typography-DUYqxpre.js";import"./icon-t35jb-S6.js";import"./tslib.es6-BHOXe2z4.js";import"./inert.esm-BjwkyC0B.js";import"./base-element-DsKKxcfh.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./query-BwR-Wesx.js";import"./class-map-BiVinSLa.js";import"./directive-CvdRHFdJ.js";import"./mwc-icon-BqP9gbHN.js";import"./ripple-handlers-DDpyjNEg.js";import"./state-BvMmCZpn.js";import"./style-map-CYkhWXm1.js";import"./aria-property-BYXgNswj.js";import"./event-options-DUJCy-Gh.js";import"./if-defined-BYt77_e6.js";import"./mwc-top-app-bar-base-SWMY4Cuu.js";import"./mwc-icon-button.css-BN1SKsX6.js";import"./mwc-radio.css-BdwV_9ok.js";import"./form-element-Y8u1xKHT.js";const x=":host{--cv-dialog-border-radius: 0;--cv-dialog-horizontal-padding: 0;--cv-dialog-vertical-padding: 0;--mdc-dialog-scrim-color: transparent;--mdc-dialog-min-width: 100vw;--mdc-dialog-max-width: 100vw;--mdc-dialog-min-height: 100vh;--mdc-dialog-max-height: 100vh}.mdc-dialog .mdc-dialog__container{opacity:1;transform:translate(100%);transition:transform .3s ease}.mdc-dialog--opening .mdc-dialog__container{transform:translate(100%)}.mdc-dialog--open .mdc-dialog__container{transform:translate(0);transition:transform .3s ease}.mdc-dialog--closing .mdc-dialog__container{opacity:1;transform:translate(100%);transition:transform .3s ease}";var w=Object.defineProperty,q=Object.getOwnPropertyDescriptor,d=(t,e,n,i)=>{for(var o=i>1?void 0:i?q(e,n):e,c=t.length-1,a;c>=0;c--)(a=t[c])&&(o=(i?a(e,n,o):a(o))||o);return i&&o&&w(e,n,o),o};let s=class extends y{constructor(){super(...arguments),this.helpOpen=!1,this.helpResizable=!1}getInitialFocusEl(){const t=`[${this.initialFocusAttribute}]`,e=this.querySelector(t);return e||this.renderRoot.querySelector("cv-focused-page")}render(){return h` <div
      class="mdc-dialog"
      role="alertdialog"
      aria-modal="true"
...
}`,...(g=(u=r.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};const oe=["Basic"];export{r as Basic,oe as __namedExportsOrder,ee as default};
