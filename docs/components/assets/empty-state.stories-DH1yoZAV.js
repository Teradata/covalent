...
Please contact your system administrator for further details.`,action:!1,twoActions:!0,icon:"work"},tags:["autodocs"]},a=({headline:o,subtitle:n,action:i,twoActions:e,icon:t})=>`
  <cv-empty-state 
    headline="${o}" 
    subtitle="${n}"
    icon="${t}"
