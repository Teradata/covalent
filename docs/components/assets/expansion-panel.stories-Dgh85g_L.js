import{l as I,e as P,s as w,x as v,r as S,i as C}from"./query-assigned-elements-TXvH8BPC.js";import{n as i}from"./property-jaip2ZBL.js";import"./icon-DGxKLRfL.js";import"./action-ribbon-BIk5IZlt.js";import"./button-DGgSiZo9.js";import"./mwc-icon-BO_vOlXN.js";import"./tslib.es6-C-hQhb2A.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./foundation-BmszT0UM.js";import"./foundation-D9HcNlNd.js";import"./class-map-s1sGgw8A.js";import"./directive-CvdRHFdJ.js";import"./query-C-WWPLnw.js";import"./ripple-handlers-Y4T00Vej.js";import"./base-element-CYNOzLiN.js";import"./state-C-wh0DpU.js";import"./style-map-BRLUR99k.js";import"./aria-property-BYXgNswj.js";import"./event-options-DSmr0rIs.js";import"./if-defined-BRq_wxIY.js";var B=Object.defineProperty,O=Object.getOwnPropertyDescriptor,u=(n,t,s,r)=>{for(var e=r>1?void 0:r?O(t,s):t,l=n.length-1,p;l>=0;l--)(p=n[l])&&(e=(r?p(t,s,e):p(e))||e);return r&&e&&B(t,s,e),e};let m=class extends w{constructor(){super(...arguments),this.noSurface=!1,this.titleWidth="150px",this._handleToggle=n=>{const t=n.detail.index,s=this.panelItems[t],r=s.open;this.panelItems.forEach(e=>{e.resetPanel()}),r&&(s.open=!0,this.panelItems.forEach(e=>{e.index==t-1?e.index==0?e.separateSinglePanel=!0:e.aboveOpenInnerPanel=!0:e.index==t+1&&(e.index==this.panelItems.length-1&&(e.separateSinglePanel=!0),e.belowOpenInnerPanel=!0)}))}}render(){return v`
      <div class="container">
        <div class="content">
  ...
  return \`
    ...
    \`;
}`,...(y=(b=c.parameters)==null?void 0:b.docs)==null?void 0:y.source}}};const Z=["Basic","NoSurface"];export{d as Basic,c as NoSurface,Z as __namedExportsOrder,X as default};
