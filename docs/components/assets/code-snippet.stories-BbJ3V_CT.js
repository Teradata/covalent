...
`,Ke={title:"Components/Code snippet",args:{hideHeader:!1,inline:!1,label:"Example.sql",language:"sql",content:B,maxHeight:0}},v=({inline:t,content:e,hideHeader:n,label:r,language:o,maxHeight:a})=>(document.addEventListener("DOMContentLoaded",()=>{const i=document.querySelector("#theme-toggle");x.on(F,p=>{p?i.setAttribute("icon","brightness_high"):i.setAttribute("icon","brightness_4")}),i.addEventListener("click",()=>{x.emit(G)})},{once:!0}),`
...
}`,...($=(R=s.parameters)==null?void 0:R.docs)==null?void 0:$.source}}};var P,N,L;l.parameters={...l.parameters,docs:{...(P=l.parameters)==null?void 0:P.docs,source:{originalSource:`({
  inline,
  content,
  hideHeader,
  label,
...
}`,...(L=(N=l.parameters)==null?void 0:N.docs)==null?void 0:L.source}}};var k,w,I;u.parameters={...u.parameters,docs:{...(k=u.parameters)==null?void 0:k.docs,source:{originalSource:`({
  inline,
  content,
  hideHeader,
  label,
  ...
  return \`
    ...
    \`;
}`,...(q=(j=c.parameters)==null?void 0:j.docs)==null?void 0:q.source}}};const je=["Basic","Scrollable","HiddenHeader","Dialog"];export{s as Basic,c as Dialog,u as HiddenHeader,l as Scrollable,je as __namedExportsOrder,Ke as default};
