import{s as v,x as h,e as m,i as g,r as R}from"./query-assigned-elements-DrVEbY-Z.js";import{n as r}from"./property-jaip2ZBL.js";import{_ as e}from"./tslib.es6-BHOXe2z4.js";import{s as y}from"./mwc-icon-button.css-BN1SKsX6.js";import{R as $,e as O}from"./ripple-handlers-DDpyjNEg.js";import{a as w}from"./aria-property-BYXgNswj.js";import{t as L}from"./state-BvMmCZpn.js";import{e as f}from"./event-options-DUJCy-Gh.js";import{i as _}from"./query-BwR-Wesx.js";import{o as H}from"./class-map-BiVinSLa.js";import{l as u}from"./if-defined-BYt77_e6.js";/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */class t extends v{constructor(){super(...arguments),this.disabled=!1,this.onIcon="",this.offIcon="",this.on=!1,this.shouldRenderRipple=!1,this.rippleHandlers=new $(()=>(this.shouldRenderRipple=!0,this.ripple))}handleClick(){this.on=!this.on,this.dispatchEvent(new CustomEvent("icon-button-toggle-change",{detail:{isOn:this.on},bubbles:!0}))}click(){this.mdcRoot.focus(),this.mdcRoot.click()}focus(){this.rippleHandlers.startFocus(),this.mdcRoot.focus()}blur(){this.rippleHandlers.endFocus(),this.mdcRoot.blur()}renderRipple(){return this.shouldRenderRipple?h`
            <mwc-ripple
