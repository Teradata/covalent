...
`;var S=Object.defineProperty,D=Object.getOwnPropertyDescriptor,L=(a,e,r,t)=>{for(var n=t>1?void 0:t?D(e,r):e,i=a.length-1,s;i>=0;i--)(s=a[i])&&(n=(t?s(e,r,n):s(n))||n);return t&&n&&S(e,r,n),n};let h=class extends o{};h.styles=[$`
      ${k(O)}
    `];h=L([C("cv-alert")],h);const K={title:"Components/Alert",parameters:{layout:"padded"},argTypes:{state:{options:["neutral","active","positive","negative","caution"],control:{type:"select"}},actionElement:{options:["button","close icon","none"],control:{type:"select"}}},args:{title:"Alert title",description:"Alert description",state:"active",actionElement:"button"}},b=({title:a,description:e,state:r,icon:t,actionElement:n,inline:i})=>{switch(r){case"positive":t="check";break;case"negative":t="error";break;case"caution":t="warning";break;case"active":default:t="info"}return`
        <cv-alert
          titleText="${a}"
          descriptionText="${e}"
          state="${r}"
