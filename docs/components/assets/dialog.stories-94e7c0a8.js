...
`,A=({})=>(document.addEventListener("DOMContentLoaded",()=>{const n=document.body.querySelectorAll("cv-button[data-num]");for(let l=0;l<n.length;l++){const i=n[l],c=i.dataset.num,v=(p=>function(){const b=document.body.querySelector("#dialog"+p);b.open=!0})(c);i.addEventListener("click",v)}window.toggleActions.onclick=function(){const l=document.body.querySelector("#dialog4"),i=document.body.querySelector("#hideActionVal"),c=!l.hideActions;l.hideActions=c,i.innerText=c};const R=document.querySelector("#dialog8"),a=document.querySelector("#dialog8-text-field");document.querySelector("#dialog8-primary-action-button").addEventListener("click",()=>{if(a.checkValidity()){R.close();return}a.reportValidity()})},{once:!0}),h),P={title:"Components/Dialog",properties:{darkMode:{current:"dark",stylePreview:!0}}},f=({isDark:n})=>`<div class="${n?"dark":null}">
...
}`,...(u=(y=o.parameters)==null?void 0:y.docs)==null?void 0:u.source}}};var x,w,m;e.parameters={...e.parameters,docs:{...(x=e.parameters)==null?void 0:x.docs,source:{originalSource:`({}) => {
  return \`<style>
              cv-formfield {
                  margin-left: -.75rem;
              }
...
}`,...(m=(w=e.parameters)==null?void 0:w.docs)==null?void 0:m.source}}};const H=["Basic","Anatomy","Logout","UDF"];export{t as Anatomy,k as Basic,o as Logout,e as UDF,H as __namedExportsOrder,P as default};
//# sourceMappingURL=dialog.stories-94e7c0a8.js.map
