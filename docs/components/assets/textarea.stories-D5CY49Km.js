import{n as h,x as b,i as O,r as L,e as R}from"./query-assigned-elements-BJdb4KNY.js";import{_ as p}from"./tslib.es6-BHOXe2z4.js";import{T as w,l as z,s as A,a as B}from"./textfield-DmB9B6rJ.js";import{i as H}from"./query-pFbEai1B.js";import{o as I}from"./class-map-LmxYoNzI.js";import{l as s}from"./if-defined-dAx6j6jI.js";import"./mwc-line-ripple-directive-B6OhpibM.js";import"./base-element-C3CkHPn4.js";import"./utils-DQt7ZoY7.js";import"./directive-CvdRHFdJ.js";import"./form-element-BQMFi4zf.js";import"./observer-D8jHVEI7.js";import"./state-CGn7W7VL.js";import"./event-options-CZVCfsC0.js";import"./directive-helpers-7tzC9zVi.js";/**
 * @license
 ...
 * SPDX-LIcense-Identifier: Apache-2.0
 */const U=O`.mdc-text-field{height:100%}.mdc-text-field__input{resize:none}`;var E=Object.getOwnPropertyDescriptor,D=(e,r,n,l)=>{for(var t=l>1?void 0:l?E(r,n):r,a=e.length-1,$;a>=0;a--)($=e[a])&&(t=$(t)||t);return t};let c=class extends o{};c.styles=[A,U,O`${L(B)}`];c=D([R("cv-textarea")],c);const ee={title:"Components/Text area",argTypes:{style:{options:["outlined","filled"],control:{type:"radio"}}},args:{style:"outlined",disabled:!1},tags:["autodocs"]},m=({label:e,style:r,disabled:n,required:l,helper:t})=>`
        <cv-textarea 
            label="${e??r}"
            ${r}
            ${t?`helper="${t}"`:null}
