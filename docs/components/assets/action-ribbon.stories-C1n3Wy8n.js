import"./action-ribbon-BIk5IZlt.js";import"./button-DGgSiZo9.js";import"./icon-DGxKLRfL.js";import"./query-assigned-elements-TXvH8BPC.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./foundation-BmszT0UM.js";import"./tslib.es6-C-hQhb2A.js";import"./foundation-D9HcNlNd.js";import"./class-map-s1sGgw8A.js";import"./directive-CvdRHFdJ.js";import"./property-jaip2ZBL.js";import"./query-C-WWPLnw.js";import"./mwc-icon-BO_vOlXN.js";import"./ripple-handlers-Y4T00Vej.js";import"./base-element-CYNOzLiN.js";import"./state-C-wh0DpU.js";import"./style-map-BRLUR99k.js";import"./aria-property-BYXgNswj.js";import"./event-options-DSmr0rIs.js";import"./if-defined-BRq_wxIY.js";const an={title:"Components/Action Ribbon",parameters:{layout:"fullscreen"},argTypes:{label:{control:"text"},icon:{control:"text"}}},n=({label:R="No changes",color:E,icon:s,saveDisabled:O=!1})=>`
    <cv-action-ribbon
      labelText="${R}"
      state="${E}" 
      ${s?`icon="${s}"`:null}
...
}`,...(_=(P=l.parameters)==null?void 0:P.docs)==null?void 0:_.source}}};const tn=["Neutral","Active","Positive","Negative","Caution","Loading","Pending","Checked"];export{o as Active,t as Caution,l as Checked,c as Loading,a as Negative,n as Neutral,i as Pending,e as Positive,tn as __namedExportsOrder,an as default};
