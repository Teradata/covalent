import{i as L,r as w,e as O}from"./query-assigned-elements-DrVEbY-Z.js";import{n as _}from"./property-jaip2ZBL.js";import{a as E,s as q}from"./dialog-C4t-v-qD.js";import"./button-DL8Q-BuB.js";import{Active as C}from"./status-header.stories-Bylsxzix.js";import{t as x}from"./table-row-selection.content-tSLjFSBa.js";/* empty css                           */import"./tslib.es6-BHOXe2z4.js";import"./inert.esm-BjwkyC0B.js";import"./base-element-DsKKxcfh.js";import"./utils-DQt7ZoY7.js";import"./observer-D8jHVEI7.js";import"./query-BwR-Wesx.js";import"./class-map-BiVinSLa.js";import"./directive-CvdRHFdJ.js";import"./mwc-icon-BqP9gbHN.js";import"./ripple-handlers-DDpyjNEg.js";import"./state-BvMmCZpn.js";import"./style-map-CYkhWXm1.js";import"./aria-property-BYXgNswj.js";import"./event-options-DUJCy-Gh.js";import"./if-defined-BYt77_e6.js";import"./icon-t35jb-S6.js";import"./circular-progress-vxrruSTq.js";const D=":host{--cv-side-sheet-width: 800px;--mdc-dialog-heading-ink-color: var(--mdc-theme-text-primary-on-background)}.mdc-dialog{justify-content:flex-end}.mdc-dialog .mdc-dialog__surface{border-radius:0;height:100%;min-height:inherit;max-height:inherit;min-width:var(--cv-side-sheet-width, 400px)}.mdc-dialog--opening .mdc-dialog__container{transform:translate(100%);transition:transform .15s cubic-bezier(.4,0,1,1)}.mdc-dialog--open .mdc-dialog__container{transform:translate(0)}.mdc-dialog--closing .mdc-dialog__container{opacity:1;transform:translate(100%);transition:transform .15s cubic-bezier(0,0,.2,1)}:host([pushed]) .mdc-dialog__surface{min-width:100vw}:host([noPadding]) .mdc-dialog .mdc-dialog__content{padding:0}";var P=Object.defineProperty,T=Object.getOwnPropertyDescriptor,h=(e,t,s,n)=>{for(var o=n>1?void 0:n?T(t,s):t,a=e.length-1,l;a>=0;a--)(l=e[a])&&(o=(n?l(t,s,o):l(o))||o);return n&&o&&P(t,s,o),o};let d=class extends E{constructor(){super(),this.pushed=!1,this.noPadding=!1,this.hideActions=!0}};d.styles=[q,L`
      ${w(D)}
    `];h([_({type:Boolean,reflect:!0})],d.prototype,"pushed",2);h([_({type:Boolean,reflect:!0})],d.prototype,"noPadding",2);d=h([O("cv-side-sheet")],d);const ne={title:"Components/Side sheet",argTypes:{onClick:{action:"clicked"}},parameters:{actions:{handles:["click cv-button"]}}},i=()=>(document.addEventListener("DOMContentLoaded",()=>{var t;const e=document.querySelector("cv-side-sheet");(t=document.querySelector("cv-button"))==null||t.addEventListener("click",()=>e!=null&&e.open?e.close():e==null?void 0:e.show())},{once:!0}),`
  ...
  return \`
    ...
    \`;
}`,...(f=(y=c.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};const oe=["Basic","Multiple","StatusHeader"];export{i as Basic,r as Multiple,c as StatusHeader,oe as __namedExportsOrder,ne as default};
