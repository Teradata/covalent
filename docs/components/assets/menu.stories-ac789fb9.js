...
`;var z=Object.defineProperty,G=Object.getOwnPropertyDescriptor,H=(d,n,s,i)=>{for(var t=i>1?void 0:i?G(n,s):n,m=d.length-1,v;m>=0;m--)(v=d[m])&&(t=(i?v(n,s,t):v(t))||t);return i&&t&&z(n,s,t),t};let b=class extends F{};b.styles=[R,N`
  ...
  \`;
}`,...(x=(j=l.parameters)==null?void 0:j.docs)==null?void 0:x.source}}};const be=["Basic","absolute","quickOpen","fullwidth","stayOpenOnBodyClick","corner","defaultFocus"];export{e as Basic,be as __namedExportsOrder,o as absolute,u as corner,ve as default,l as defaultFocus,r as fullwidth,c as quickOpen,a as stayOpenOnBodyClick};
