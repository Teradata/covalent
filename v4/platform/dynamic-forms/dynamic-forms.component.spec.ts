  ...
  beforeEach(
    waitForAsync(() => {
      TestBed.configureTestingModule({
        imports: [NoopAnimationsModule, MatNativeDateModule, CovalentDynamicFormsModule, TdDynamicTestModule],
        ...
        fixture.whenStable().then(() => {
          ...
          fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
              ...
              expect(fixture.debugElement.query(By.css('#custom-error')).nativeElement.textContent).toBe(
                'CUSTOM_ERROR',
              );
            });
          });
  ...
  it(
    ...
    waitForAsync(
      inject([], () => {
        ...
        fixture.detectChanges();
        fixture.whenStable().then(() => {
          const customComponent: TdDynamicTestComponent = fixture.debugElement.query(
