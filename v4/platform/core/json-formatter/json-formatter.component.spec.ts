...
import { CovalentJsonFormatterModule, TdJsonFormatterComponent } from './';
...
describe('Component: JsonFormatter', () => {
  ...
  it(
    'should render component with undefined in it',
    waitForAsync(
      inject([], () => {
  ...
  it(
    'should render component with key truncated and elipsis',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdJsonFormatterBasicTestComponent);
        ...
        fixture.whenStable().then(() => {
          fixture.detectChanges();
          expect(fixture.debugElement.queryAll(By.css('.key'))[0].nativeElement.textContent.trim()).toBe(
  ...
  it(
    'should throw error if [levelsOpen] is not an integer',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdJsonFormatterBasicTestComponent);
        const component: TdJsonFormatterBasicTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component with key and values depending on type',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdJsonFormatterBasicTestComponent);
        const component: TdJsonFormatterBasicTestComponent = fixture.debugElement.componentInstance;
        ...
        fixture.whenStable().then(() => {
          ...
          expect(fixture.debugElement.queryAll(By.css('.key'))[1].nativeElement.textContent.trim()).toBe(
            'dateProperty:',
          );
          expect(fixture.debugElement.query(By.css('.date'))).toBeTruthy();
          expect(fixture.debugElement.queryAll(By.css('.key'))[2].nativeElement.textContent.trim()).toBe(
            'numberProperty:',
          );
          expect(fixture.debugElement.query(By.css('.number'))).toBeTruthy();
          expect(fixture.debugElement.queryAll(By.css('.key'))[3].nativeElement.textContent.trim()).toBe(
            'functionProperty:',
          );
          expect(fixture.debugElement.query(By.css('.function'))).toBeTruthy();
          expect(fixture.debugElement.queryAll(By.css('.key'))[4].nativeElement.textContent.trim()).toBe(
            'nullProperty:',
          );
          expect(fixture.debugElement.query(By.css('.null'))).toBeTruthy();
          expect(fixture.debugElement.queryAll(By.css('.key'))[5].nativeElement.textContent.trim()).toBe(
            'undefinedProperty:',
          );
          expect(fixture.debugElement.query(By.css('.undefined'))).toBeTruthy();
          expect(fixture.debugElement.queryAll(By.css('.key'))[6].nativeElement.textContent.trim()).toBe(
            'arrayProperty:',
          );
  ...
  it(
    'should render component with an array hidden',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdJsonFormatterBasicTestComponent);
        const component: TdJsonFormatterBasicTestComponent = fixture.debugElement.componentInstance;
        ...
        fixture.whenStable().then(() => {
          ...
          fixture.whenStable().then(() => {
            expect(
              (<HTMLElement>fixture.debugElement.query(By.css('.td-object-children')).nativeElement).style.height,
            ).toBe('0px');
          });
        });
      }),
  ...
  it(
    'should render component with an array hidden, click on node and then display array content',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdJsonFormatterBasicTestComponent);
        const component: TdJsonFormatterBasicTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component with an array display by 1 level',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdJsonFormatterBasicTestComponent);
        const component: TdJsonFormatterBasicTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component and rerender data only when refresh method explicitly called',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdJsonFormatterBasicTestComponent);
        const component: TdJsonFormatterBasicTestComponent = fixture.debugElement.componentInstance;
