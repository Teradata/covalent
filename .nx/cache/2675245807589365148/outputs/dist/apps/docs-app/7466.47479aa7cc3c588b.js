...
(self.webpackChunkdocs_app = self.webpackChunkdocs_app || []).push([
  [7466],
  {
    87466: (z, v, c) => {
      ...
      class b {
        constructor(m, e) {
          (this.source = m), (this.value = e);
        }
      }
      const C = { provide: R.JU, useExisting: (0, i.Gpc)(() => g), multi: !0 },
        ...
        class r {
          ...
          _updateSelectedRadioFromValue() {
            this._radios &&
              ...
              ((this._selected = null),
              this._radios.forEach((o) => {
                (o.checked = this.value === o.value),
                  o.checked && (this._selected = o);
              }));
          }
          _emitChangeEvent() {
            this._isInitialized &&
              this.change.emit(new b(this._selected, this._value));
          }
          _markRadiosForCheck() {
          ...
          static #e = (this.ɵfac = function (o) {
            return new (o || r)(i.Y36(i.sBO));
          });
          static #i = (this.ɵdir = i.lG2({
            type: r,
            inputs: {
              color: 'color',
              name: 'name',
      ...
      let A = (() => {
          class r extends T {
            ...
            set checked(e) {
              ...
              this._checked !== o &&
                ((this._checked = o),
                o && this.radioGroup && this.radioGroup.value !== this.value
                  ? (this.radioGroup.selected = this)
                  : !o &&
                    this.radioGroup &&
                    this.radioGroup.value === this.value &&
                    (this.radioGroup.selected = null),
                o && this._radioDispatcher.notify(this.id, this.name),
            ...
            constructor(e, o, d, t, a, u, _, l) {
              super(o),
                (this._changeDetector = d),
                (this._focusMonitor = t),
                (this._radioDispatcher = a),
                (this._providerOverride = _),
                (this._uniqueId = 'mat-radio-' + ++h),
                ...
                l && (this.tabIndex = (0, s.su)(l, 0));
            }
            focus(e, o) {
              o
                ? this._focusMonitor.focusVia(this._inputElement, o, e)
            ...
            ngOnInit() {
              this.radioGroup &&
                ...
                (this._removeUniqueSelectionListener =
                  this._radioDispatcher.listen((e, o) => {
              ...
              if ((e.stopPropagation(), !this.checked && !this.disabled)) {
                ...
                (this.checked = !0),
                  ...
                  this.radioGroup &&
                    ...
                    o && this.radioGroup._emitChangeEvent());
              }
            }
                ...
                ((o =
                  e && e.selected && !this.disabled
                    ? e.selected === this
                      ...
                      : -1
                    : this.tabIndex),
                o !== this._previousTabIndex)
              ) {
                const d = this._inputElement?.nativeElement;
                d &&
                  (d.setAttribute('tabindex', o + ''),
                  (this._previousTabIndex = o));
              }
            }
            static #e = (this.ɵfac = function (o) {
              i.$Z();
            ...
            static #i = (this.ɵdir = i.lG2({
              ...
              viewQuery: function (o, d) {
                if ((1 & o && i.Gf(M, 5), 2 & o)) {
                  let t;
                  i.iGM((t = i.CRH())) && (d._inputElement = t.first);
                }
              },
              inputs: {
                id: 'id',
        ...
        g = (() => {
          class r extends G {
            static #e = (this.ɵfac = (() => {
              let e;
              return function (d) {
                return (e || (e = i.n5z(r)))(d || r);
              };
            })());
            static #i = (this.ɵdir = i.lG2({
              type: r,
              selectors: [['mat-radio-group']],
              contentQueries: function (o, d, t) {
                if ((1 & o && i.Suo(t, f, 5), 2 & o)) {
                  let a;
                  i.iGM((a = i.CRH())) && (d._radios = a);
                }
              },
              hostAttrs: ['role', 'radiogroup', 1, 'mat-mdc-radio-group'],
              exportAs: ['matRadioGroup'],
              features: [i._Bn([C, { provide: p, useExisting: r }]), i.qOj],
            }));
          }
          return r;
        })(),
            ...
            static #i = (this.ɵcmp = i.Xpm({
              ...
              hostBindings: function (o, d) {
                1 & o &&
                  ...
                  2 & o &&
                    (i.uIk('id', d.id)('tabindex', null)('aria-label', null)(
                      'aria-labelledby',
                      null
                    )('aria-describedby', null),
                    i.ekj('mat-primary', 'primary' === d.color)(
                      'mat-accent',
                      'accent' === d.color
                    )('mat-warn', 'warn' === d.color)(
              ...
              template: function (o, d) {
                if (
                  (1 & o &&
                    ...
                    i.NdJ('click', function (a) {
                      return d._onTouchTargetClick(a);
                    }),
                    i.qZA(),
                    i.TgZ(4, 'input', 4, 5),
                    i.NdJ('change', function (a) {
                      return d._onInputInteraction(a);
                    }),
                    i.qZA(),
                    i.TgZ(6, 'div', 6),
                    i._UZ(7, 'div', 7)(8, 'div', 8),
                    i.qZA(),
                    i.TgZ(9, 'div', 9),
                    i._UZ(10, 'div', 10),
                    i.qZA()(),
                  ...
                  i.ekj(
                    ...
                    'before' == d.labelPosition
                  ),
                    i.xp6(2),
                    i.ekj('mdc-radio--disabled', d.disabled),
                    i.xp6(2),
                    i.Q6J('id', d.inputId)('checked', d.checked)(
                      'disabled',
                      d.disabled
                    )('required', d.required),
                    i.uIk('name', d.name)('value', d.value)(
                      'aria-label',
                      d.ariaLabel
        ...
        B = (() => {
          class r {
            ...
            static #i = (this.ɵmod = i.oAB({ type: r }));
            static #o = (this.ɵinj = i.cJS({
              imports: [n.BQ, x.ez, n.si, n.BQ],
            }));
          }
          return r;
        })();
