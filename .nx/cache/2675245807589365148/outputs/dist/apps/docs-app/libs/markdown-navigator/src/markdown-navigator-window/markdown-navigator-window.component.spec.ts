...
describe('MarkdownNavigatorWindowComponent', () => {
  ...
  it('should use default labels if labels is undefined', waitForAsync(
    inject([], async () => {
      const fixture: ComponentFixture<TdMarkdownNavigatorWindowTestComponent> =
        TestBed.createComponent(TdMarkdownNavigatorWindowTestComponent);

      await wait(fixture);

      const markdownNavigatorWindow: TdMarkdownNavigatorWindowComponent =
  ...
  it('should use labels if passed in', waitForAsync(
    inject([], async () => {
      ...
      expect(markdownNavigatorWindow.toggleDockedStateLabel).toBe(
        SAMPLE_LABELS.dock
      );
  ...
  it('default to primary color if toolbarColor is not passed in', waitForAsync(
    inject([], async () => {
      const fixture: ComponentFixture<TdMarkdownNavigatorWindowWOColorTestComponent> =
        TestBed.createComponent(TdMarkdownNavigatorWindowWOColorTestComponent);
  ...
  it('emit a close event ', waitForAsync(
    inject([], async () => {
      ...
      jest.spyOn(markdownNavigatorWindow.closed, 'emit');

      const closeButton: DebugElement = fixture.debugElement.query(
        By.css('.td-window-dialog-close')
      );
  ...
  it('pass compareWith item to markdownNavigator component', waitForAsync(
    inject([], async () => {
      ...
      const markdownNavigator: TdMarkdownNavigatorWindowComponent =
        fixture.debugElement.query(
          By.directive(TdMarkdownNavigatorWindowComponent)
        ).componentInstance;
