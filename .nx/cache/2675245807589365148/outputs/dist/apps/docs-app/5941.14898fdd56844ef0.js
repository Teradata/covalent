    ...
    36581: (y, h, t) => {
      ...
      function W(n, o) {
        if (
          ...
          e.xp6(6), e.Oqu(c.name);
        }
      }
      function Z(n, o) {
        1 & n && e.YNc(0, W, 7, 1, 'ng-container', 9),
          2 & n && e.Q6J('ngIf', o.$implicit);
      }
      const N = () => ({
          value: 40,
          name: 'Accessibility',
        ...
        ye = (n, o) => ({ colorSaturation: n, itemStyle: o }),
        Se = (0, f.uw)({
          overviewDemoComponent: (() => {
            class n {
              ...
              constructor(c, s) {
                (this._cdr = c), (this.themeSelector = s);
              }
              ngOnInit() {
                var c = this;
                return (0, S.Z)(function* () {
                  (c.selectedTheme = c.themeSelector.selected),
                    c._cdr.markForCheck();
                })();
              }
              selectChartTheme(c) {
                this.themeSelector.select(c);
              }
              static ɵfac = function (s) {
                return new (s || n)(e.Y36(e.sBO), e.Y36(B.n));
              };
              static ɵcmp = e.Xpm({
                type: n,
                ...
                template: function (s, a) {
                  1 & s &&
                    ...
                    e.NdJ('valueChange', function (b) {
                      return (a.selectedTheme = b);
                    })('valueChange', function (b) {
                      return a.selectChartTheme(b);
                    }),
                    ...
                    e.YNc(9, Z, 1, 1, 'ng-template', 6),
                    e.qZA(),
                    e._UZ(10, 'td-chart-series', 7),
                    e.qZA()),
                    2 & s &&
                      (e.xp6(4),
                      e.Q6J('value', a.selectedTheme),
                      e.xp6(1),
                      e.Q6J('ngForOf', a.themes),
                      e.xp6(1),
                      e.Udp('height', 600, 'px'),
                      e.Q6J(
                        'themeName',
                        e.lcZ(7, 15, a.themeSelector.selected$)
                      ),
                      e.xp6(2),
                      e.Q6J('trigger', 'item'),
                      e.xp6(2),
                      e.Q6J('top', '10%')('left', '10%')('bottom', '10%')(
                        ...
                        e.kEZ(
                          ...
                          e.VKq(
                            ...
                            e.kEZ(
                              ...
                              e.VKq(45, ne, e.VKq(43, i, e.DdM(42, ee)))
                            )
                          ),
                          e.VKq(
                            84,
                            ...
                            e.qbA(
                              78,
                              T,
                              e.VKq(56, se, e.VKq(54, i, e.DdM(53, oe))),
                              e.VKq(61, ie, e.VKq(59, i, e.DdM(58, ue))),
                              e.VKq(66, he, e.VKq(64, i, e.DdM(63, re))),
                              e.VKq(71, Ae, e.VKq(69, i, e.DdM(68, me))),
                              e.VKq(76, ve, e.VKq(74, i, e.DdM(73, ge)))
                            )
                          )
                        )
                      )('visibleMin', 300)('label', e.DdM(90, Pe))(
                        'leafDepth',
                        2
                      )(
                        'levels',
                        e.kEZ(
                          108,
                          g,
                          e.VKq(94, D, e.VKq(92, v, e.DdM(91, fe))),
                          e.VKq(99, D, e.VKq(97, v, e.DdM(96, Ce))),
                          e.WLB(
                            105,
                            ye,
                            e.DdM(101, Te),
                            e.VKq(103, v, e.DdM(102, De))
                          )
                        )
                      ));
                },
    ...
    39419: (y, h, t) => {
      ...
      let m = (() => {
        class l {
          ...
          static ɵmod = r.oAB({ type: l });
          static ɵinj = r.cJS({ imports: [u.ez, A.Ps] });
        }
        return l;
      })();
    },
