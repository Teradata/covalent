...
(self.webpackChunkdocs_app = self.webpackChunkdocs_app || []).push([
  [5778],
  {
    35778: (mt, Y, H) => {
      H.r(Y),
        H.d(Y, {
          CompletionAdapter: () => ye,
          DefinitionAdapter: () => De,
          DiagnosticsAdapter: () => xe,
          DocumentColorAdapter: () => We,
          DocumentFormattingEditProvider: () => Te,
          DocumentHighlightAdapter: () => Pe,
          DocumentLinkAdapter: () => ht,
          DocumentRangeFormattingEditProvider: () => je,
          DocumentSymbolAdapter: () => Se,
          FoldingRangeAdapter: () => Oe,
          HoverAdapter: () => Ie,
          ReferenceAdapter: () => Fe,
          RenameAdapter: () => Le,
          SelectionRangeAdapter: () => Ue,
          WorkerManager: () => q,
          fromPosition: () => C,
          fromRange: () => J,
          setupMode: () => pt,
          ...
          if ((n && 'object' == typeof n) || 'function' == typeof n)
            for (let t of Qe(n))
              !Ge.call(e, t) &&
                ...
                Be(e, t, {
                  get: () => n[t],
                  enumerable: !(r = $e(n, t)) || r.enumerable,
                });
          return e;
        },
        c = {};
      ...
      ((e = k || (k = {})).create = function n(r, t) {
        return (
          r === Number.MAX_VALUE && (r = z.MAX_VALUE),
          t === Number.MAX_VALUE && (t = z.MAX_VALUE),
          { line: r, character: t }
        );
      }),
        (e.is = function i(r) {
            ...
            (e.is = function i(r) {
              ...
              return (
                ...
                (s.undefined(a.relatedInformation) ||
                  s.typedArray(a.relatedInformation, $.is))
              );
            });
        })(S || (S = {})),
        (function (e) {
          ...
          (this._textEditChanges = Object.create(null)),
            void 0 !== n
              ? ((this._workspaceEdit = n),
                n.documentChanges
                  ? ((this._changeAnnotations = new ie(n.changeAnnotations)),
          ...
          (e.create = function n(r, t) {
            ...
            (e.is = function i(r) {
              ...
              return (
                s.defined(t) &&
                p.is(t.range) &&
                (s.undefined(t.command) || P.is(t.command))
              );
            });
        })(ke || (ke = {})),
        (function (e) {
          ...
          (e.create = function n(a, o, u, g) {
            ...
            (e.applyEdits = function r(a, o) {
              for (
                var u = a.getText(),
                  g = t(o, function (I, V) {
                    var ze = I.range.start.line - V.range.start.line;
                    return 0 === ze
                      ? I.range.start.character - V.range.start.character
                      : ze;
                  }),
                  d = u.length,
                  v = g.length - 1;
      ...
      !(function (e) {
        ...
        (e.defined = function i(f) {
          ...
          (e.numberRange = function u(f, I, V) {
            return '[object Number]' === n.call(f) && I <= f && f <= V;
          }),
      ...
      var Ie = class {
        ...
        provideHover(e, n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t) return { range: _(t.range), contents: dt(t.contents) };
            });
        }
      };
      function Re(e) {
      ...
      function dt(e) {
        if (e) return Array.isArray(e) ? e.map(Re) : [Re(e)];
      }
      var Pe = class {
        constructor(e) {
          this._worker = e;
        ...
        provideDocumentHighlights(e, n, i) {
          ...
          return this._worker(r)
            ...
            .then((t) => {
              if (t)
                return t.map((a) => ({ range: _(a.range), kind: ft(a.kind) }));
            });
        }
      };
      function ft(e) {
        ...
        je = class {
          ...
          provideDocumentRangeFormattingEdits(e, n, i, r) {
            ...
            return this._worker(t).then((a) =>
              a.format(t.toString(), J(n), Ne(i)).then((o) => {
      ...
      var We = class {
          ...
          provideColorPresentations(e, n, i) {
            ...
            return this._worker(r)
              .then((t) =>
                t.getColorPresentations(r.toString(), n.color, J(n.range))
              )
              .then((t) => {
                if (t)
                  return t.map((a) => {
        ...
        return (
          (function a() {
            ...
            He(i),
              ...
              u.hovers &&
                i.push(c.languages.registerHoverProvider(o, new Ie(t))),
              u.documentHighlights &&
                i.push(
                  c.languages.registerDocumentHighlightProvider(o, new Pe(t))
                ),
              u.definitions &&
                i.push(c.languages.registerDefinitionProvider(o, new De(t))),
              u.references &&
                i.push(c.languages.registerReferenceProvider(o, new Fe(t))),
              u.documentSymbols &&
                i.push(
                  c.languages.registerDocumentSymbolProvider(o, new Se(t))
                ),
              u.rename &&
                i.push(c.languages.registerRenameProvider(o, new Le(t))),
              u.colors &&
                i.push(c.languages.registerColorProvider(o, new We(t))),
              u.foldingRanges &&
                i.push(c.languages.registerFoldingRangeProvider(o, new Oe(t))),
              u.diagnostics && i.push(new xe(o, t, e.onDidChange)),
              u.selectionRanges &&
                i.push(
                  c.languages.registerSelectionRangeProvider(o, new Ue(t))
                ),
