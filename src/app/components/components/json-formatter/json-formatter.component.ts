...
@Component({
  ...
  styleUrls: ['app/components/components/json-formatter/json-formatter.component.scss'],
  templateUrl: 'app/components/components/json-formatter/json-formatter.component.html',
})
