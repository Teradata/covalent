...
const RAW_GH_URL: string = 'https://raw.githubusercontent.com/Teradata/covalent/main/README.md';
const GH_URL: string = 'https://github.com/Teradata/covalent/blob/main/README.md';
const BRANCH_GH_URL: string = 'https://github.com/Teradata/covalent/blob/main/README.md';
const RAW_GH_BRANCH_URL: string = 'https://raw.githubusercontent.com/Teradata/covalent/main/README.md';
const NON_MARKDOWN_URL: string = 'https://teradata.github.io/covalent/#/';
const UNREACHABLE_URL: string = 'https://github.com/Teradata/covalent/tree/main/lib';
