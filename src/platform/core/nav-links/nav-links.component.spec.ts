...
describe('TdNavLinksComponent', () => {
  ...
  it('should display 1 href link', waitForAsync(async () => {
    component.links = [
      {
  ...
  it('should display 1 router link', waitForAsync(async () => {
    component.links = [
      {
        label: 'Duck Duck Go',
  ...
  it('should display 1 href link and 1 router link', waitForAsync(async () => {
    component.links = [
      {
        label: 'Duck Duck Go',
        link: { href: 'https://duckduckgo.com/' },
  ...
  it('should display 1 hidden href link and 1 router link', waitForAsync(async () => {
    component.links = [
      {
        label: 'Duck Duck Go',
        link: { href: 'https://duckduckgo.com/' },
  ...
  it('should display 1 group with 1 routelink and 1 href', waitForAsync(async () => {
    component.links = [
      {
        label: 'Group 1 Links',
        children: [
  ...
  it('should display 2 group and 4 links', waitForAsync(async () => {
    component.links = [
      {
        label: 'Group 1 Links',
        children: [
