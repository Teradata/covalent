...
`<td-layout-nav-list>` is a layout component which lets you customize a `navigation` view with toolbar items, item selections and footers.
...
```html
<td-layout-nav-list sidenavTitle="title" logo="logo" opened="true" mode="side" sidenavWidth="350px">
