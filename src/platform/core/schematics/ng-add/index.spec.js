...
describe('ng-add schematic', () => {
    ...
    it('should create theme.scss', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testRunner.runSchematicAsync('ng-add', {}, appTree).toPromise();
        expect(tree.exists('theme.scss')).toBe(true);
    }));
    it('should import component themes to theme.scss if selected', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not import component themes to theme.scss if not selected', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should include sass mixins to theme.scss if selected', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should not include sass mixins to theme.scss if selected', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should include theme.scss in angular config', () => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const tree = yield testRunner.runSchematicAsync('ng-add', {}, appTree).toPromise();
