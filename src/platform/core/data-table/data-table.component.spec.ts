...
describe('Component: DataTable', () => {
  ...
  it('should set hidden and not get search hits and set it to false and get search results', (done: DoneFn) => {
    inject([TdDataTableService], (tdDataTableService: TdDataTableService) => {
      ...
      fixture.whenStable().then(() => {
        ...
        expect(
          fixture.debugElement.queryAll(By.directive(TdDataTableColumnComponent)).filter((col: DebugElement) => {
  ...
  describe('selectable and multiple', () => {
        ...
        fixture.whenStable().then(() => {
          ...
          fixture.whenStable().then(() => {
            ...
            fixture.debugElement
              .queryAll(By.directive(MatPseudoCheckbox))[2]
        ...
        fixture.whenStable().then(() => {
          ...
          fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
              ...
              fixture.debugElement
                .queryAll(By.directive(MatPseudoCheckbox))[0]
                .triggerEventHandler('click', new Event('click'));
              fixture.debugElement
                .queryAll(By.directive(MatPseudoCheckbox))[1]
                .triggerEventHandler('click', new Event('click'));
              fixture.debugElement
                .queryAll(By.directive(MatPseudoCheckbox))[3]
                .triggerEventHandler('click', new Event('click'));
              fixture.detectChanges();
              fixture.whenStable().then(() => {
                // check to see if its in indeterminate state and allSelected
        ...
        fixture.whenStable().then(() => {
          ...
          fixture.whenStable().then(() => {
            ...
            fixture.whenStable().then(() => {
              ...
              fixture.debugElement
                .queryAll(By.directive(MatPseudoCheckbox))[3]
                .nativeElement.dispatchEvent(shiftClickEvent);
              fixture.detectChanges();
              fixture.whenStable().then(() => {
    ...
    it('should click on a row and see the rowClick Event', waitForAsync(
      inject([], () => {
    ...
    it('should click on a row and see the rowClick event only when clicking on row', waitForAsync(
      inject([], () => {
    ...
    it('should load table and have first row checked by reference', waitForAsync(
      inject([], () => {
    ...
    it('should load table and have no rows checked by reference', waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdDataTableModelTestComponent);
        const component: TdDataTableModelTestComponent = fixture.debugElement.componentInstance;
    ...
    it('should load table and have first row checked using [compareWith]', waitForAsync(
      inject([], () => {
