...
describe('Component: NotificationCount', () => {
  ...
  it(
    'should render component with no notification tip',
    waitForAsync(
      inject([], () => {
  ...
  it(
    'should render component notification tip with no count nor number',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountBasicTestComponent);
  ...
  it(
    'should render component notification tip with count and number',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountBasicTestComponent);
        const component: TdNotificationCountBasicTestComponent = fixture.debugElement.componentInstance;
        ...
        fixture.whenStable().then(() => {
          ...
          expect(
            fixture.debugElement.query(By.css('.td-notification-count')).nativeElement.textContent.trim(),
          ).toContain(component.notifications);
        });
      }),
    ),
  );
  ...
  it(
    'should render component with notification tip hidden',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountBasicTestComponent);
        const component: TdNotificationCountBasicTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component with notification tip and then hide it',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountBasicTestComponent);
        const component: TdNotificationCountBasicTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component notification tip with defaultLimit+ when limit is not set and when count exceeds the default',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountBasicTestComponent);
        const component: TdNotificationCountBasicTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component notification tip with count when limit is not set and when count does not exceed default',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountBasicTestComponent);
        const component: TdNotificationCountBasicTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component notification tip with limit+ when limit is set',
    waitForAsync(
      inject([], () => {
  ...
  it(
    'should render component notification tip with notifications when it is less than the limit',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountLimitTestComponent);
        const component: TdNotificationCountLimitTestComponent = fixture.debugElement.componentInstance;
  ...
  it(
    'should render component with content transcluded',
    waitForAsync(
      inject([], () => {
  ...
  it(
    'should render component with content and default positionY top and position X after',
    waitForAsync(
      inject([], () => {
  ...
  it(
    'should render component with no content and default positionY top and position X after',
    waitForAsync(
      inject([], () => {
  ...
  it(
    'should render component with positionY bottom and position X before',
    waitForAsync(
      inject([], () => {
        const fixture: ComponentFixture<any> = TestBed.createComponent(TdNotificationCountPositionTestComponent);
        const component: TdNotificationCountPositionTestComponent = fixture.debugElement.componentInstance;
