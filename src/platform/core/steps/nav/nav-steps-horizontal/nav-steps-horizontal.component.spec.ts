...
describe('Component: Nav Steps Horizontal', () => {
  ...
  it('should hide paginations buttons when steps fit screen', waitForAsync(
    inject([], () => {
      const fixture: ComponentFixture<any> = TestBed.createComponent(TdNavStepsHorizontalTestComponent);
      fixture.detectChanges();
      fixture.whenStable().then(() => {
  ...
  it('should resize window and hide pagination buttons if steps dont fit screen', waitForAsync(
    inject([], () => {
      const fixture: ComponentFixture<any> = TestBed.createComponent(TdNavStepsHorizontalTestComponent);
      fixture.detectChanges();
      fixture.whenStable().then(() => {
