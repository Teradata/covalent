...
describe('Component: Steps', () => {
  ...
  it('should render vertical step with label, sublabel and content hidden', waitForAsync(
    inject([], () => {
  ...
  it('should render vertical step with active content', waitForAsync(
    inject([], () => {
      const fixture: ComponentFixture<any> = TestBed.createComponent(TdStepsBasicTestComponent);
      const component: TdStepsBasicTestComponent = fixture.debugElement.componentInstance;
      component.label = 'Label';
  ...
  it('should render horizontal step with hidden content', waitForAsync(
    inject([], () => {
      const fixture: ComponentFixture<any> = TestBed.createComponent(TdStepsBasicTestComponent);
      const component: TdStepsBasicTestComponent = fixture.debugElement.componentInstance;
      component.label = 'Label';
  ...
  it('should render horizontal step with active content', waitForAsync(
    inject([], () => {
      const fixture: ComponentFixture<any> = TestBed.createComponent(TdStepsBasicTestComponent);
      const component: TdStepsBasicTestComponent = fixture.debugElement.componentInstance;
      component.label = 'Label';
  ...
  it('should render vertical step with required state', waitForAsync(
    inject([], () => {
      const fixture: ComponentFixture<any> = TestBed.createComponent(TdStepsBasicTestComponent);
      const component: TdStepsBasicTestComponent = fixture.debugElement.componentInstance;
      component.label = 'Label';
  ...
  it('should render vertical step with complete state and summary', waitForAsync(
    inject([], () => {
  ...
  it('should render dynamic steps from an ngFor loop', waitForAsync(
    inject([], () => {
