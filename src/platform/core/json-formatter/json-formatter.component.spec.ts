  ...
  it('should render component with key and values depending on type', async(
    inject([], () => {
      ...
      fixture.whenStable().then(() => {
        ...
        expect(fixture.debugElement.queryAll(By.css('.key'))[1].nativeElement.textContent.trim()).toBe('dateProperty:');
        ...
        expect(fixture.debugElement.queryAll(By.css('.key'))[4].nativeElement.textContent.trim()).toBe('nullProperty:');
