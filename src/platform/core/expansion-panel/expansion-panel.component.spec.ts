...
describe('Component: ExpansionPanel', () => {
  ...
  it('should render expansion panel with label, sublabel and content hidden', waitForAsync(
    inject([], () => {
  ...
  it('should render expansion panel summary', waitForAsync(
    inject([], () => {
  ...
  it('should mimic panel click, expand content, hide summary', waitForAsync(
    inject([], () => {
      const fixture: ComponentFixture<any> = TestBed.createComponent(TdExpansionPanelBasicTestComponent);
      fixture.detectChanges();
      fixture.whenStable().then(() => {
