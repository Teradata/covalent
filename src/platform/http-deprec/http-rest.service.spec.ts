...
describe('Service: RESTService', () => {
  ...
  it('expect to do a query succesfully', async(
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
  ...
  it('expect to do a query and use the service transform() and then override it with a method transform()', async(
    inject([TransformTestRESTService, MockBackend], (service: TransformTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
            new ResponseOptions({
    ...
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        expect(connection.request.url).toBe(
          'www.url.com/path/to/endpoint?firstParam=1&second-Param=value&thirdParam=false',
  ...
  it('expect to do a get and use the service transform() and then override it with a method transform()', async(
    inject([TransformTestRESTService, MockBackend], (service: TransformTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
      ...
      complete = false;
      service
        .get('id-of-something', (res: Response) => {
          return { data: res.json(), transformFrom: 'method' };
        })
        .subscribe(
          (data: any) => {
  ...
  it('expect to do a get failure', async(
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockError(new Error('error'));
      });
  ...
  it('expect to do a create succesfully', async(
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        expect(connection.request.url).toBe('www.url.com/path/to/endpoint', 'url didnt match the expected url');
  ...
  it('expect to do a create and use the service transform() and then override it with a method transform()', async(
    inject([TransformTestRESTService, MockBackend], (service: TransformTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
  ...
  it('expect to do a create failure', async(
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockError(new Error('error'));
      });
  ...
  it('expect to do an update and use the service transform() and then override it with a method transform()', async(
    inject([TransformTestRESTService, MockBackend], (service: TransformTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
      ...
      let error: boolean = false;
      let complete: boolean = false;
      service.update('id-of-something', {}).subscribe(
        (data: any) => {
          expect(data.data).toBe('success');
          expect(data.transformFrom).toBe('service');
          success = true;
      ...
      complete = false;
      service
        .update('id-of-something', {}, (res: Response) => {
          return { data: res.json(), transformFrom: 'method' };
        })
        .subscribe(
          (data: any) => {
  ...
  it('expect to do a update failure', async(
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockError(new Error('error'));
      });
  ...
  it('expect to do a delete succesfully with observables', async(
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        expect(connection.request.url).toBe(
          'www.url.com/path/to/endpoint/id-of-something',
  ...
  it('expect to do a delete and use the service transform() and then override it with a method transform()', async(
    inject([TransformTestRESTService, MockBackend], (service: TransformTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
      ...
      complete = false;
      service
        .delete('id-of-something', (res: Response) => {
          return { data: res.json(), transformFrom: 'method' };
        })
        .subscribe(
          (data: any) => {
  ...
  it('expect to do a delete failure', async(
    inject([BasicTestRESTService, MockBackend], (service: BasicTestRESTService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockError(new Error('error'));
      });
  ...
  it('expect to do a query succesfully with baseHeaders', async(
    inject(
      [BaseHeadersTestRESTService, MockBackend],
  ...
  it('expect to do a query succesfully with dynamicHeaders', async(
    inject(
      [DynamicHeadersTestRESTService, MockBackend],
