...
describe('Service: HttpInterceptor', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [CovalentHttpModule.forRoot(config)],
      providers: [
        MockBackend,
        {
          provide: XHRBackend,
  ...
  it('expect to intercept only the route with `/recovery/*/fromerror` and recover from a failure', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        if (connection.request.url === 'http://www.test.com/recovery/id/fromerror') {
          ...
          expect(connection.request.headers.get('recovered')).toBeNull(
      ...
      service
        .patch('http://www.test.com/recovery/id/id2/fromerror', {})
      ...
      service
        .patch('http://www.test.com/recovery/id/fromerror', {})
        .pipe(map((res: Response) => res.json()))
        .subscribe((data: string) => {
  ...
  it('expect to intercept only the route with `/error` and fail', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
  ...
  it('expect to intercept all routes and add an `auth=test-auth` header', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
      ...
      service
        .post('http://www.test.com/any_path?query=1&query=2', {})
        .pipe(map((res: Response) => res.json()))
        .subscribe((data: string) => {
          expect(data).toBeTruthy();
        });
      ...
      service
        .get('http://www.test.com/url/any-path/111')
        .pipe(map((res: Response) => res.json()))
        .subscribe((data: string) => {
          expect(data).toBeTruthy();
        });
      ...
      service
        .get('http://www.test.com/anypath/url')
        .pipe(map((res: Response) => res.json()))
        .subscribe((data: string) => {
          expect(data).toBeTruthy();
        });
      ...
      service
        .delete('http://www.test.com/any_path?', {})
        .pipe(map((res: Response) => res.json()))
        .subscribe((data: string) => {
          expect(data).toBeTruthy();
        });
      ...
      service
        .patch('http://www.test.com/any-path/111/another_path/', {})
        .pipe(map((res: Response) => res.json()))
        .subscribe((data: string) => {
          expect(data).toBeTruthy();
        });
  ...
  it('expect to intercept routes that contain `/url` in them and override responses body with `override`', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
...
describe('Service: HttpInterceptor', () => {
  ...
  it('expect to do a forkJoin get succesfully with observables', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
      ...
      forkJoin(service.get('testurl'), service.get('testurl')).subscribe(
        (response: Response[]) => {
          success = true;
        },
        () => {
  ...
  it('expect to do a post succesfully with observables', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
  ...
  it('expect to do a post failure with observables', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
  ...
  it('expect to do a post succesfully with promises', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockRespond(
          new Response(
  ...
  it('expect to do a post failure with promises', async(
    inject([HttpInterceptorService, MockBackend], (service: HttpInterceptorService, mockBackend: MockBackend) => {
      mockBackend.connections.subscribe((connection: MockConnection) => {
        connection.mockError(new Error('error'));
      });
