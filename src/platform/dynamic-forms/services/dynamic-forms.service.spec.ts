...
import { TdDynamicFormsService, TdDynamicType, TdDynamicElement } from './dynamic-forms.service';
...
describe('Service: TdDynamicFormsService', () => {
  ...
  it('expect to validate element names correctly', waitForAsync(
  ...
  it('expect to return components depending on type | element', waitForAsync(
    inject([TdDynamicFormsService], (service: TdDynamicFormsService) => {
