...
describe('Decorators: Http', () => {
  ...
  it('expect to do a query succesfully', waitForAsync(
    inject(
  ...
  it('expect to do a query failure', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        service.query().subscribe(
  ...
  it('expect to do a query with HttpParams parameters successfully', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        let success: boolean = false;
  ...
  it('expect to do a query with HttpParams parameters with a custom encoder successfully', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        let success: boolean = false;
  ...
  it('expect to do a query with object parameters succesfully', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        let success: boolean = false;
  ...
  it('expect to do a get succesfully', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        let success: boolean = false;
  ...
  it('expect to do a create succesfully', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        let success: boolean = false;
  ...
  it('expect to do an update succesfully', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        let success: boolean = false;
  ...
  it('expect to do an delete succesfully', waitForAsync(
    inject(
      [BasicTestRESTService, HttpTestingController],
      (service: BasicTestRESTService, httpTestingController: HttpTestingController) => {
        let success: boolean = false;
  ...
  it('expect to do a query succesfully with baseHeaders', waitForAsync(
    inject(
