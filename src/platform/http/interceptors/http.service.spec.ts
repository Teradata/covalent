...
describe('Service: Http', () => {
  ...
  it('expect to intercept only the route with `/error` and fail', waitForAsync(
    inject(
  ...
  it('expect to intercept all routes and add an `auth=test-auth` header', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
        service
  ...
  it('expect to intercept routes that contain `/url` in them and override responses body with `override`', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
        service
  ...
  it('expect to intercept only the route with `/recovery/*/fromerror` and recover from a failure', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
...
describe('Service: Http', () => {
  ...
  it('expect to do a forkJoin get succesfully with observables', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
  ...
  it('expect to do a post succesfully with observables', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
        const testUrl: string = '/testurl';
  ...
  it('expect to do a post failure with observables', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
        const testUrl: string = '/testurl';
  ...
  it('expect to do a post succesfully with promises', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
        const testUrl: string = '/testurl';
  ...
  it('expect to do a post failure with promises', waitForAsync(
    inject(
      [TdHttpService, HttpTestingController],
      (service: TdHttpService, httpTestingController: HttpTestingController) => {
        const testUrl: string = '/testurl';
