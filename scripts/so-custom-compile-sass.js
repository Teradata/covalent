...
gulp.task('compile-file-sass', 'Build the module styles', function() {
  return gulp
    .src(['src/platform/core/file/**/**.scss'])
    .pipe(sourcemaps.init())
    .pipe(sass({
      errLogToConsole: true,
      importer: sassImporter,
    ...
    .pipe(sourcemaps.write('.'))
    .pipe(gulp.dest('dist/packages/core/file'));
});

gulp.task('compile-json-formatter-sass', 'Build the module styles', function() {
  return gulp
    .src(['src/platform/core/json-formatter/**/**.scss'])
    .pipe(sourcemaps.init())
    .pipe(sass({
      errLogToConsole: true,
      importer: sassImporter,
...
gulp.task('compile-loading-sass', 'Build the module styles', function() {
  return gulp
    .src(['src/platform/core/loading/**/**.scss'])
    .pipe(sourcemaps.init())
    .pipe(sass({
      errLogToConsole: true,
      importer: sassImporter,
    ...
    .pipe(sourcemaps.write('.'))
    .pipe(gulp.dest('dist/packages/core/loading'));
});
