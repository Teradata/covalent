  ...
  <div class="dialog">
    ...
    <div class="dialogContent">
      ...
      <div class="dialogActions">
        <cv-button outlined>BUTTON TEXT</cv-button>
        <cv-button class="dark primary">BUTTON TEXT</cv-button>
      </div>
    </div>
  </div>
</div>
...
<div class="dark darkText exampleContainer">
  <cv-card cardTitle="Title" class="card">
    ...
    <div slot="card-actions" class="mdc-card__action-buttons">
      <cv-button outlined class="whiteOutline">
        BUTTON TEXT
      </cv-button>
      <cv-button class="primary">BUTTON TEXT</cv-button>
    </div>
  </cv-card>
  <div class="cardContainer">
    <cv-card cardTitle="Title">
  ...
  <div class="dialog darkDialog">
    ...
    <div class="dialogContent">
      ...
      <div class="dialogActions">
        <cv-button outlined>BUTTON TEXT</cv-button>
        <cv-button class="light primary">BUTTON TEXT</cv-button>
      </div>
    </div>
  </div>
</div>
