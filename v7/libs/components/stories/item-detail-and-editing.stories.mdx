...
<div class="container">
  <div class="toolbar">
    ...
    <div class="actions">
      <cv-button outlined slot="buttonActions" label="Action"></cv-button>
      <cv-button outlined slot="buttonActions" label="Action"></cv-button>
    </div>
  </div>
  <cv-tab-bar activeIndex="0">
    <cv-tab label="Details"></cv-tab>
    <cv-tab label="Tab 2"></cv-tab>
    <cv-tab label="Tab 3"></cv-tab>
    <cv-tab label="Tab 4"></cv-tab>
  </cv-tab-bar>
  <hr />
  <div class="content">
    <div>
  ...
  <div class="changes-container-item">
    ...
    <div class="changes-example">
      ...
      <cv-action-ribbon labelText="No changes">
        <cv-button slot="action-items" label="Cancel" outlined></cv-button>
        <cv-button slot="action-items" label="Save" raised disabled></cv-button>
      </cv-action-ribbon>
  ...
  <div class="changes-container-item">
    ...
    <div class="changes-example">
      ...
      <cv-action-ribbon labelText="You have unsaved changes" state="active">
        <cv-button slot="action-items" label="Cancel" outlined></cv-button>
        <cv-button slot="action-items" label="Save" raised></cv-button>
      </cv-action-ribbon>
      <div class="action-ribbon-bottom-content">
        <div class="skeleton-text">
          Filler text filler text filler text filler text filler text filler
