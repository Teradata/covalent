...
<div class="item">
  <div class="left">
    ...
    <div class="see-also">
      <div>See also</div>
      <span>
        Features <cv-icon>chevron_right</cv-icon>
        <a
  ...
  <div class="step-title right">
    ...
    <div class="action-bar">
      <div>2/4</div>
      <div>
        <cv-icon class="chevron-space">chevron_left</cv-icon>
        <cv-icon>chevron_right</cv-icon>
      </div>
    </div>
      ...
      <div class="help-window">
        <div class="toolbar">
          ...
          <div class="icon-container">
            <cv-icon>expand_more</cv-icon>
            <cv-icon>open_in_new</cv-icon>
        ...
        <div class="card-content">
          <span class="help-window-crumbs">
            All topics <cv-icon>chevron_right</cv-icon> Developer
            <cv-icon>chevron_right</cv-icon>
          </span>
