import * as iconList from './material-codepoints.json';
...
export const COV_ICON_LIST = [
  ...
  'product_agentops',
  'product_agentops_outlined',
  'product_aimodelhub',
  'product_aimodelhub_outlined',
  'product_ask_ai',
  'product_ask_ai_outlined',
  'product_aistudio',
  ...
  'product_openid',
  'product_openid_outlined',
  'product_saml',
  'product_saml_outlined',
  'product_querygrid',
  ...
  'slack',
  'state_approved',
  'state_approved_outlined',
  'state_cancelled',
  'state_cancelled_outlined',
  'state_caution',
  'state_caution_outlined',
  'state_code_deployed',
  'state_code_deployed_outlined',
  'state_code_retired',
  'state_code_retired_outlined',
  'state_created_document',
  'state_created_document_outlined',
  'state_changed',
  'state_changed_outlined',
  'state_model_evaluated',
  'state_model_evaluated_outlined',
  'state_model_trained',
  'state_model_trained_outlined',
  'state_negative',
  ...
  'state_ready_for_review_outlined',
  'state_rejected',
  'state_rejected_outlined',
  'state_scheduled',
  'state_scheduled_outlined',
  'state_stopped',
  'state_stopped_outlined',
  'state_suspended',
